...
function dawp_virtual_page_map() {
    return [
        ...
        'contact-us'           => ['slug' => 'contact',              'title' => 'Contact Topgoodmart', 'desc' => 'Contact Topgoodmart support for help with orders, tracking, returns, refunds, product questions or privacy requests.', 'css' => 'tw-contact.css', 'canonical_path' => 'contact-us', 'schema_type' => 'ContactPage', 'image' => get_template_directory_uri() . '/assets/img/gallery/Customer_support_scene_in_office_202607161445.jpeg'],
