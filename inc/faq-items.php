...
if (!function_exists('dawp_get_faq_items')) {
    function dawp_get_faq_items() {
        return [
            ...
            ['group' => 'The Watch', 'question' => 'What movement is inside?', 'answer' => 'A carefully selected automatic movement, fitted in our atelier. It runs at 28,800 vibrations per hour, carries 24 jewels, and holds a power reserve of approximately 40 hours. We regulate every movement in five positions before delivery.'],
