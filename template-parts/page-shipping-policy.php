<?php
/**
 * Shipping policy page for Crowdfused.
 *
 * @package dawp
 */
...
<div class="bg-white text-[#222222]">
    <section class="bg-[#FAFAFA] py-14 sm:py-20" aria-labelledby="shipping-policy-title">
        <div class="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end lg:px-8">
            <div>
                <p class="text-sm font-extrabold uppercase tracking-[0.14em] text-[#F58220]"><?php esc_html_e('Shipping Policy', 'dawp'); ?></p>
                <h1 id="shipping-policy-title" class="mt-4 font-heading text-4xl font-extrabold leading-tight text-[#222222] sm:text-5xl">
            ...
            <div class="rounded-md border border-[#E9ECEF] bg-white p-6 shadow-sm">
                ...
                <div class="mt-6 flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
                    <a href="<?php echo esc_url($track_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md bg-[#F58220] px-6 text-sm font-bold text-white transition hover:bg-[#E96F00]">
                        <?php esc_html_e('Track Order', 'dawp'); ?>
                    </a>
                    <a href="<?php echo esc_url($contact_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md border border-[#F58220] bg-white px-6 text-sm font-bold text-[#F58220] transition hover:bg-[#FAFAFA]">
    ...
    <section class="bg-[#FAFAFA] py-12 sm:py-16">
        ...
        <section class="rounded-md border border-[#E9ECEF] bg-white p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="shipping-locations-title">
            <h1 id="shipping-locations-title" class="font-heading text-4xl font-extrabold leading-tight text-[#222222] sm:text-5xl">
                <?php esc_html_e('Shipping Locations & Market', 'dawp'); ?>
            </h1>
            <div class="mt-5 space-y-5 text-sm leading-7 text-[#666666] sm:text-base">
                <p><?php esc_html_e('We currently ship exclusively within the United States. Crowdfused serves customers shopping from the United States domestic market.', 'dawp'); ?></p>
                ...
                <div class="border-l-4 border-[#E9ECEF] bg-[#FAFAFA] p-5 text-[#666666]">
        ...
        <section class="rounded-md border border-[#E9ECEF] bg-[#FAFAFA] p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="shipping-costs-title">
            <h2 id="shipping-costs-title" class="font-heading text-4xl font-extrabold leading-tight text-[#222222]">
                <?php esc_html_e('Shipping Fees & Costs', 'dawp'); ?>
            </h2>
            <p class="mt-5 text-sm leading-7 text-[#666666] sm:text-base">
            ...
            <div class="mt-6 grid gap-4 md:grid-cols-2">
                <?php foreach ($shipping_costs as $cost) : ?>
                    <article class="rounded-md border border-[#E9ECEF] bg-white p-5">
                        <h3 class="font-heading text-xl font-extrabold text-[#222222]"><?php echo esc_html($cost['title']); ?></h3>
                        <p class="mt-4 text-sm leading-7 text-[#666666] sm:text-base"><?php echo esc_html($cost['copy']); ?></p>
                    </article>
                <?php endforeach; ?>
            </div>
        </section>

        <section class="rounded-md border border-[#E9ECEF] bg-white p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="delivery-times-title">
            <h2 id="delivery-times-title" class="font-heading text-4xl font-extrabold leading-tight text-[#222222]">
            ...
            <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <?php foreach ($delivery_times as $time) : ?>
                    <article class="rounded-md border border-[#E9ECEF] bg-white p-5">
                        <h3 class="text-sm font-extrabold text-[#222222]"><?php echo esc_html($time['title']); ?></h3>
                        <p class="mt-3 text-sm leading-6 text-[#666666]"><?php echo esc_html($time['copy']); ?></p>
                    </article>
                <?php endforeach; ?>
            </div>
            <p class="mt-6 text-sm leading-7 text-[#666666] sm:text-base">
        ...
        <section class="rounded-md border border-[#E9ECEF] bg-[#FAFAFA] p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="multi-item-title">
            <h2 id="multi-item-title" class="font-heading text-4xl font-extrabold leading-tight text-[#222222]">
        ...
        <section class="rounded-md border border-[#E9ECEF] bg-white p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="carrier-title">
            <h2 id="carrier-title" class="font-heading text-4xl font-extrabold leading-tight text-[#222222]">
                <?php esc_html_e('Carrier Services & Delivery Tracking', 'dawp'); ?>
            </h2>
            <p class="mt-5 text-sm leading-7 text-[#666666] sm:text-base">
                <?php esc_html_e('To guarantee safe and efficient delivery, Crowdfused partners with trusted domestic U.S. carriers. Orders are shipped using USPS, UPS, FedEx, or DHL.', 'dawp'); ?>
            </p>
            <div class="mt-5 flex flex-wrap gap-3">
                <?php foreach ($carriers as $carrier) : ?>
                    <span class="inline-flex min-h-9 items-center justify-center rounded-full border border-[#E9ECEF] bg-white px-6 text-sm font-extrabold text-[#222222]"><?php echo esc_html($carrier); ?></span>
                <?php endforeach; ?>
            </div>
            <p class="mt-5 text-sm leading-7 text-[#666666] sm:text-base">
            ...
            <div class="mt-7">
                <a href="<?php echo esc_url($track_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-full border border-[#222222] bg-white px-6 text-sm font-extrabold text-[#222222] transition hover:bg-[#E96F00] hover:text-white">
                    <?php esc_html_e('Track Order', 'dawp'); ?>
                </a>
            </div>
        </section>

        <section class="rounded-md border border-[#E9ECEF] bg-[#FAFAFA] p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="delivery-issues-title">
            <h2 id="delivery-issues-title" class="font-heading text-4xl font-extrabold leading-tight text-[#222222]">
            ...
            <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                <a href="<?php echo esc_url($contact_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-full bg-[#F58220] px-6 text-sm font-extrabold text-white transition hover:bg-[#F58220]">
                    <?php esc_html_e('Contact Support', 'dawp'); ?>
                </a>
        ...
        <section class="rounded-md border border-[#E9ECEF] bg-white p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="support-contact-title">
            <h2 id="support-contact-title" class="font-heading text-4xl font-extrabold leading-tight text-[#222222]">
            ...
            <div class="mt-7 rounded-md border border-[#E9ECEF] p-5">
                <div class="grid gap-4 md:grid-cols-2">
                    <?php foreach ($contact_details as $detail) : ?>
                        <div class="rounded-md border border-[#E9ECEF] bg-white p-5">
                            <h3 class="text-sm font-extrabold text-[#222222]"><?php echo esc_html($detail['label']); ?></h3>
        ...
        <section class="rounded-md border border-[#E9ECEF] bg-white p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="shipping-faq-title">
            <h2 id="shipping-faq-title" class="font-heading text-4xl font-extrabold leading-tight text-[#222222]">
            ...
            <div class="mt-6 divide-y divide-[#E9ECEF]">
                <?php foreach ($shipping_faqs as $item) : ?>
                    <details class="group py-5 first:pt-0 last:pb-0">
                        ...
                        <p class="mt-3 text-sm leading-7 text-[#666666] sm:text-base"><?php echo esc_html($item['answer']); ?></p>
                    </details>
                <?php endforeach; ?>
            </div>
        </section>
