            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <?php foreach ($policy_cards as $card) : ?>
                    <div class="rounded-lg border border-[#D8C3A5] border-t-4 border-t-[#9A6242] bg-white p-6 shadow-sm">
                        ...
                        <p class="mt-3 font-heading text-2xl font-black leading-snug text-[#5A3825]"><?php echo esc_html($card['value']); ?></p>
                    </div>
                <?php endforeach; ?>
            </div>
            ...
            <div class="mt-12 grid gap-10 lg:grid-cols-[240px_minmax(0,1fr)] lg:items-start">
                <aside class="rounded-lg border border-[#D8C3A5] bg-white p-5 shadow-sm lg:sticky lg:top-24">
                    ...
                    <nav class="mt-5 space-y-3" aria-label="<?php esc_attr_e('Shipping and returns policy sections', 'dawp'); ?>">
                        <a class="block rounded-md border border-transparent px-4 py-3 text-sm font-bold leading-5 text-[#24211E] transition hover:border-[#9A6242] hover:bg-[#F8F1E7]" href="#shipping-policy"><?php esc_html_e('Shipping Policy', 'dawp'); ?></a>
                        <a class="block rounded-md border border-transparent px-4 py-3 text-sm font-bold leading-5 text-[#24211E] transition hover:border-[#9A6242] hover:bg-[#F8F1E7]" href="#tracking-address"><?php esc_html_e('Tracking & Address', 'dawp'); ?></a>
                        <a class="block rounded-md border border-transparent px-4 py-3 text-sm font-bold leading-5 text-[#24211E] transition hover:border-[#7A7B52] hover:bg-[#F8F1E7]" href="#return-policy"><?php esc_html_e('Return Eligibility', 'dawp'); ?></a>
                        <a class="block rounded-md border border-transparent px-4 py-3 text-sm font-bold leading-5 text-[#24211E] transition hover:border-[#7A7B52] hover:bg-[#F8F1E7]" href="#return-process"><?php esc_html_e('Return Process', 'dawp'); ?></a>
                        <a class="block rounded-md border border-transparent px-4 py-3 text-sm font-bold leading-5 text-[#24211E] transition hover:border-[#C8A45D] hover:bg-[#F8F1E7]" href="#refunds-support"><?php esc_html_e('Refunds & Support', 'dawp'); ?></a>
                    </nav>
                </aside>

                <div class="space-y-10">
                    <article id="shipping-policy" class="scroll-mt-24 rounded-lg border border-[#D8C3A5] bg-white p-5 shadow-sm sm:p-7 lg:p-10">
                        <h2 class="font-heading text-3xl font-black leading-tight text-[#5A3825]"><?php esc_html_e('Shipping Policy', 'dawp'); ?></h2>
                        <div class="mt-6 max-w-none text-base leading-7 text-[#4F463F] [&_h3+div]:mt-5 [&_h3+p]:mt-5 [&_li]:leading-7 [&_p+p]:mt-4">
                            <p class="rounded-lg border border-[#C8A45D]/60 bg-[#F8F1E7] p-5 font-medium leading-7 text-[#5A3825]"><?php esc_html_e('This policy applies to eligible products purchased directly from Scott Osterbind. We review each order for payment confirmation, product availability, shipping details, and item condition before fulfillment begins.', 'dawp'); ?></p>

                            <h3 class="mt-10 rounded-md border-l-4 border-[#9A6242] bg-[#F8F1E7] px-5 py-4 text-xl font-black leading-snug text-[#5A3825]"><?php esc_html_e('Shipping Timeline', 'dawp'); ?></h3>
                            ...
                            <div class="mt-5 overflow-x-auto rounded-lg border border-[#D8C3A5]">
                                <table class="w-full min-w-[560px] table-fixed text-left text-sm leading-6 md:min-w-0">
                                    <thead class="bg-[#F8F1E7] text-[#5A3825]">
                                        <tr>
                                    ...
                                    <tbody class="divide-y divide-[#D8C3A5]">
                                        <tr>
                            ...
                            <h3 id="tracking-address" class="scroll-mt-24 mt-10 rounded-md border-l-4 border-[#9A6242] bg-[#F8F1E7] px-5 py-4 text-xl font-black leading-snug text-[#5A3825]"><?php esc_html_e('Order Tracking and Address Accuracy', 'dawp'); ?></h3>
                            ...
                            <h3 class="mt-10 rounded-md border-l-4 border-[#9A6242] bg-[#F8F1E7] px-5 py-4 text-xl font-black leading-snug text-[#5A3825]"><?php esc_html_e('Lost, Delayed, or Delivered Packages', 'dawp'); ?></h3>
                    ...
                    <article id="return-policy" class="scroll-mt-24 rounded-lg border border-[#D8C3A5] bg-white p-5 shadow-sm sm:p-7 lg:p-10">
                        <h2 class="font-heading text-3xl font-black leading-tight text-[#5A3825]"><?php esc_html_e('Return Policy', 'dawp'); ?></h2>
                        <div class="mt-6 max-w-none text-base leading-7 text-[#4F463F] [&_h3+ol]:mt-5 [&_h3+p]:mt-5 [&_h3+ul]:mt-5 [&_li]:leading-7 [&_p+p]:mt-4">
                            <p class="rounded-lg border border-[#C8A45D]/60 bg-[#F8F1E7] p-5 font-medium leading-7 text-[#5A3825]"><?php esc_html_e('You may request a return within 30 days of delivery for eligible items purchased directly from Scott Osterbind. Return approval depends on product condition, order details, and whether the item can be resold safely and honestly.', 'dawp'); ?></p>

                            <h3 class="mt-10 rounded-md border-l-4 border-[#7A7B52] bg-[#F8F1E7] px-5 py-4 text-xl font-black leading-snug text-[#5A3825]"><?php esc_html_e('Eligible Returns', 'dawp'); ?></h3>
                            <ul class="mt-5 list-disc space-y-3 pl-6">
                            ...
                            <h3 class="mt-10 rounded-md border-l-4 border-[#7A7B52] bg-[#F8F1E7] px-5 py-4 text-xl font-black leading-snug text-[#5A3825]"><?php esc_html_e('Items That May Not Be Returnable', 'dawp'); ?></h3>
                            <ul class="mt-5 list-disc space-y-3 pl-6">
                            ...
                            <h3 id="return-process" class="scroll-mt-24 mt-10 rounded-md border-l-4 border-[#C8A45D] bg-[#F8F1E7] px-5 py-4 text-xl font-black leading-snug text-[#5A3825]"><?php esc_html_e('Return Process', 'dawp'); ?></h3>
                            ...
                            <h3 class="mt-10 rounded-md border-l-4 border-[#C8A45D] bg-[#F8F1E7] px-5 py-4 text-xl font-black leading-snug text-[#5A3825]"><?php esc_html_e('Damaged, Defective, or Incorrect Items', 'dawp'); ?></h3>
                            ...
                            <h3 id="refunds-support" class="scroll-mt-24 mt-10 rounded-md border-l-4 border-[#C8A45D] bg-[#F8F1E7] px-5 py-4 text-xl font-black leading-snug text-[#5A3825]"><?php esc_html_e('Refunds, Exchanges, and Support', 'dawp'); ?></h3>
                            <ul class="mt-5 list-disc space-y-3 pl-6">
