    ...
    <section class="bg-[#F7F5EF] py-14 lg:py-20">
        <div class="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            ...
            <div>
                ...
                <p class="mt-5 text-base leading-8 text-[#475569]">
                    <?php esc_html_e('From beaded bracelets to simple layering pieces, Carlton Edgeworth focuses on handmade details, natural textures, and personal accessories that feel easy to wear and thoughtful to gift.', 'dawp'); ?>
                </p>
        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:px-8">
            <div>
                ...
                <p class="mt-5 max-w-2xl text-base leading-8 text-[#FAF6EA]">
                    <?php esc_html_e('Carlton Edgeworth brings together handmade jewelry, beaded pieces, vintage-inspired accessories, and curated finds with a personal creative point of view. Each item is selected or made to feel thoughtful, wearable, and expressive.', 'dawp'); ?>
                </p>
            </div>
