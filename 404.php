        ...
        <div class="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
            <div class="max-w-2xl">
                ...
                <p class="mt-5 max-w-2xl text-base leading-8 text-[#554E49] sm:text-lg">
                    <?php esc_html_e('The link may have changed, but you can continue shopping Chronel for luxury watches, fine timepieces, limited editions and premium accessories.', 'dawp'); ?>
                </p>
