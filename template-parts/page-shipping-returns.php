...
<style>
  .qb-page { --qb-ivory:#F6F4EF; --qb-white:#FFFFFF; --qb-gold:#B38A52; --qb-text:#555B57; --qb-border:#D8D2C7; --qb-plum:#101412; background:var(--qb-ivory); color:var(--qb-text); font-family:"DM Sans","Inter",system-ui,sans-serif; }
  ...
  .qb-hero { position:relative; overflow:hidden; background:linear-gradient(135deg,#101412 0%,#1F2A24 56%,#6D5334 100%); }
  .qb-hero::after { content:""; position:absolute; right:7%; bottom:-92px; width:360px; height:360px; border:1px solid rgba(255,255,255,.14); border-radius:999px; background:rgba(255,255,255,.04); }
  ...
  .qb-policy-card { position:relative; overflow:hidden; border:1px solid var(--qb-border); border-radius:6px; background:#fff; padding:clamp(24px,4vw,38px); box-shadow:0 16px 38px rgba(13,15,15,.06); }
  ...
  <section class="qb-hero">
    <div class="qb-wrap qb-hero__grid">
      <div class="qb-hero__content">
        ...
        <p class="qb-copy"><?php esc_html_e('Quick access to shipping details, returns, refunds, and order support.', 'dawp'); ?></p>
  ...
  <section class="qb-section qb-soft">
    <div class="qb-wrap qb-policy-grid">
      <section class="qb-policy-card">
        ...
        <p><?php esc_html_e('Review delivery locations, shipping fees, processing timelines, carrier tracking, and support for delivery issues.', 'dawp'); ?></p>
        <div class="qb-actions">
      ...
      <section class="qb-policy-card">
        ...
        <p><?php esc_html_e('Review return eligibility, return shipping fees, refund timing, non-returnable items, and support information.', 'dawp'); ?></p>
        <div class="qb-actions">
