<?php
/**
 * Privacy policy page for Chronel.
 *
 * @package dawp
 */
...
$information_collected = [
    ...
    [
        ...
        'copy'  => __('Whenever you navigate through Chronel, our servers log technical session details. This tracking includes your IP address, web browser type, referring/exit pages, approximate geographic location derived from network signals, and specific data captured via cookies or similar device identifiers.', 'dawp'),
    ],
];
...
$sharing_partners = [
    ...
    [
        ...
        'copy'  => __('We may disclose your data if strictly required to comply with applicable federal laws, tax audits, court subpoenas, or to defend the safety and property rights of Chronel and our consumers.', 'dawp'),
    ],
];
...
$sections = [
    ...
    [
        ...
        'copy'  => [
            __('Your financial safety is our highest priority. Chronel does not store, view, or retain your raw credit card numbers or sensitive payment credentials on our corporate servers.', 'dawp'),
    ...
    [
        ...
        'copy'  => [
            __('Chronel is intended for a general audience and is strictly directed toward consumers who have reached the legal age of majority. We do not knowingly or intentionally collect, solicit, or maintain personal information from children under the age of 13. If we discover that a minor under 13 has provided data, it will be immediately purged from our servers.', 'dawp'),
        ],
    ],
];
...
$privacy_faqs = [
    [
        'question' => __('Does Chronel sell my personal information?', 'dawp'),
        'answer'   => __('No. Chronel does not sell, rent, trade, or monetize personal information to third parties as a business practice.', 'dawp'),
    ],
    [
        'question' => __('Does Chronel store my full credit card number?', 'dawp'),
        ...
        <div class="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end lg:px-8">
            <div>
                ...
                <h1 id="privacy-title" class="mt-4 font-heading text-4xl font-extrabold leading-tight text-[#2B2B2B] sm:text-5xl">
                    <?php esc_html_e('How Chronel protects customer information.', 'dawp'); ?>
                </h1>
