<?php
/**
 * Homepage template for Corvelshop.
 *
 * @package dawp
 */
  ...
  <section class="qb-section qb-feature">
    <div class="qb-wrap qb-feature__grid">
      ...
      <div class="qb-feature__panel">
        ...
        <p class="qb-copy">
          <?php esc_html_e("From simple charm bracelets to owl-inspired designs, Corvelshop offers feminine jewelry pieces that feel personal, easy to wear, and thoughtful to gift.", 'dawp'); ?>
        </p>
  ...
  <section class="qb-section qb-gift">
    <div class="qb-wrap qb-gift__grid">
      <div>
        ...
        <p class="qb-copy">
          <?php esc_html_e("Whether you are choosing a bracelet for yourself or someone special, Corvelshop brings together easy-to-wear styles that feel personal, polished, and gift-ready.", 'dawp'); ?>
        </p>
  ...
  <section class="qb-section qb-trust">
    <div class="qb-wrap">
      ...
      <div class="qb-policy-box">
        ...
        <p><?php esc_html_e('For order support, contact support@corvelshop.com. Customer Service Hours: Monday-Friday, 9:00 AM-6:00 PM PST.', 'dawp'); ?></p>
      </div>
