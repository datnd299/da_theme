...
function dawp_virtual_page_map() {
    ...
    return [
        'home' => [
            'slug'            => 'home',
            'title'           => 'Home',
            'seo_title'       => 'Myveganblog | Women\'s Shoes, Handbags & Fashion Accessories',
            'seo_description' => 'Shop Myveganblog for women\'s leather shoes, sandals, handbags, and fashion accessories made for polished everyday style, weekends, travel, and gifting.',
        ...
        'about-us' => [
            'slug'            => 'about',
            'title'           => 'About Us',
            'seo_title'       => 'About Myveganblog | Practical Women\'s Style Boutique',
            'seo_description' => 'Learn about Myveganblog, a women\'s fashion accessories store focused on polished everyday footwear, handbags, clear product guidance, and wearable style.',
        ...
        'faq' => [
            'slug'            => 'faq',
            'title'           => 'FAQ',
            'seo_title'       => 'FAQ | Myveganblog Orders, Shipping, Returns & Support',
            'seo_description' => 'Find answers about Myveganblog orders, payments, shipping times, tracking, returns, refunds, product sizing, and customer support.',
        ...
        'contact-us' => [
            'slug'            => 'contact',
            'title'           => 'Contact Us',
            'seo_title'       => 'Contact Myveganblog | Customer Support',
            'seo_description' => 'Contact Myveganblog customer support for questions about women\'s shoes, sandals, handbags, accessories, shipping, returns, refunds, or an existing order.',
        ...
        'shipping-policy' => [
            ...
            'seo_title'       => 'Shipping Policy | Myveganblog U.S. Delivery & Tracking',
            'seo_description' => 'Review Myveganblog shipping locations, free U.S. standard shipping, order handling time, delivery estimates, tracking details, and carrier support.',
        ...
        'refund-return-policy' => [
            ...
            'seo_title'       => 'Refund & Return Policy | Myveganblog 30-Day Returns',
            'seo_description' => 'Read Myveganblog return eligibility, 30-day return window, return shipping fees, refund timing, exchanges, non-returnable items, and support details.',
            'seo_image'       => $image_base . 'image copy 6.png',
            'css'             => 'tw/tw-ship.css',
        ],
        'terms-conditions' => [
            ...
            'seo_title'       => 'Terms & Conditions | Myveganblog Store Policies',
            'seo_description' => 'Review the Myveganblog terms and conditions for website use, orders, payments, shipping, returns, product information, privacy, and customer responsibilities.',
        ...
        'privacy-policy' => [
            ...
            'seo_title'       => 'Privacy Policy | Myveganblog Customer Data Protection',
            'seo_description' => 'Learn how Myveganblog collects, uses, protects, and shares customer information for orders, payments, shipping, support, cookies, and privacy requests.',
            'seo_image'       => $image_base . 'image copy 6.png',
        ...
        'track-order' => [
            'slug'            => 'track-order',
            'title'           => 'Track Order',
            'seo_title'       => 'Track Your Order | Myveganblog',
            'seo_description' => 'Track your Myveganblog order status with your order details and get help with shipment updates, delivery questions, and customer support.',
            'seo_image'       => $image_base . 'banner.png',
            'css'             => 'track-order.css',
        ],
    ];
