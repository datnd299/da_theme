    ...
    <section class="bg-[#5A3825] py-14 text-white lg:py-20">
        <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p class="mx-auto mt-4 max-w-3xl text-lg leading-8 text-[#F8F1E7]">
                <?php esc_html_e('Return eligibility, return shipping fees, delivery issue support, exchanges, refund timing, non-returnable items, and contact information for Patado LLC orders.', 'dawp'); ?>
            </p>
        ...
        <div class="mx-auto max-w-6xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <article class="rounded-lg border border-[#D8C3A5] bg-white p-6 shadow-sm sm:p-8 lg:p-10">
                ...
                <div class="mt-5 rounded-lg border border-[#C8A45D] bg-[#F8F1E7] p-5">
                    <p class="font-black text-[#34243A]"><?php esc_html_e('Patado LLC - Returns Department', 'dawp'); ?></p>
