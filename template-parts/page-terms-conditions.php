<?php
/**
 * Terms and conditions page for BrickGo.
 *
 * @package dawp
 */
...
$terms_highlights = [
    [
        ...
        'copy'  => __('BrickGo is an e-commerce store focused on practical collectible toys, building sets, designer figures, art toys, blind boxes, mini figures, display pieces, and collector accessories.', 'dawp'),
    ],
    [
...
$shipping_parameters = [
    __('Shipping Locations: BrickGo currently ships exclusively within the United States domestic market (50 States).', 'dawp'),
...
$return_terms = [
    ...
    __('Defective/Damaged/Incorrect Items: BrickGo covers 100% of return shipping costs by providing a prepaid shipping label.', 'dawp'),
...
$sections = [
    [
        ...
        'copy'  => [
            __('BrickGo is an e-commerce store focused on practical collectible toys, building sets, designer figures, art toys, blind boxes, mini figures, display pieces, and collector accessories.', 'dawp'),
            ...
            __('Ethical Commerce Commitment: BrickGo strictly adheres to ethical commerce standards. We do not sell counterfeit goods, replica logos, unauthorized branded items, dietary supplements, medical devices, regulated products, or items with unverified health claims.', 'dawp'),
        ],
    ],
    [
    ...
    [
        ...
        'copy'  => [
            __('All website text, layout configurations, imagery, custom graphics, and brand logos are owned by or licensed to BrickGo and are protected by applicable intellectual property and copyright laws.', 'dawp'),
            __('To the fullest extent permitted by applicable law, BrickGo shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of website usage, delivery delays, or product handling.', 'dawp'),
        ],
    ],
    [
        ...
        <div class="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end lg:px-8">
            <div>
                ...
                <h1 id="terms-title" class="mt-4 font-heading text-4xl font-extrabold leading-tight text-[#2B2B2B] sm:text-5xl">
                    <?php esc_html_e('Terms for using and shopping with BrickGo.', 'dawp'); ?>
                </h1>
