...
function dawp_virtual_page_map() {
    return [
        'home' => [
            ...
            'title'       => 'Home',
            'css'         => 'tw/tw-home.css',
            'seo_title'   => 'Proudlywear | Patriotic Apparel & Custom Veteran Gifts',
            'description' => 'Shop Proudlywear for patriotic apparel, veteran-inspired polos, hats, America 250 designs, and custom military gifts with free U.S. standard shipping.',
        ...
        'about-us' => [
            ...
            'title'       => 'About Us',
            'css'         => 'tw/tw-about.css',
            'seo_title'   => 'About Proudlywear | Patriotic Apparel & Veteran Gifts',
        ...
        'faq' => [
            ...
            'title'       => 'FAQ',
            'css'         => 'tw/tw-faq.css',
            'seo_title'   => 'Proudlywear FAQ | Shipping, Returns & Orders',
            'description' => 'Find answers about Proudlywear orders, checkout, free U.S. shipping, tracking, returns, refunds, payment security, and customer support.',
        ...
        'contact-us' => [
            ...
            'seo_title'   => 'Contact Proudlywear | Customer Support',
            'description' => 'Contact Proudlywear for order updates, custom gift details, shipping questions, returns, refunds, delivery issues, and product support.',
            'image'       => 'assets/img/Image New/image copy 9.png',
        ],
        'shipping-policy' => [
            ...
            'css'         => 'tw/tw-ship.css',
            'seo_title'   => 'Shipping Policy | Proudlywear',
            'description' => 'Review Proudlywear shipping policy, including free standard U.S. shipping, 1-3 business day handling, 5-7 business day transit, and tracking.',
        ...
        'refund-return-policy' => [
            ...
            'css'         => 'tw/tw-ship.css',
            'seo_title'   => 'Refund & Return Policy | Proudlywear',
            'description' => 'Review Proudlywear returns and refunds, including the 30-day return window, eligible item condition, return shipping fees, and refund timing.',
            'image'       => 'assets/img/Image New/image copy 9.png',
        ],
        'terms-conditions' => [
            ...
            'css'         => 'tw/tw-terms.css',
            'seo_title'   => 'Terms & Conditions | Proudlywear',
            'description' => 'Read Proudlywear terms and conditions for website use, online orders, payment security, product accuracy, returns, and store policies.',
        ...
        'privacy-policy' => [
            ...
            'seo_title'   => 'Privacy Policy | Proudlywear',
            'description' => 'Read how Proudlywear collects, uses, protects, and shares personal information for orders, checkout, shipping, analytics, and support.',
            'image'       => 'assets/img/Image New/image copy.png',
        ],
        'track-order' => [
            'slug'        => 'track-order',
            'title'       => 'Track Order',
            'css'         => 'track-order.css',
            'seo_title'   => 'Track Your Order | Proudlywear',
            'description' => 'Track your Proudlywear order status securely using your order details, or contact customer support for shipment and delivery help.',
            'image'       => 'assets/img/Image New/image copy 3.png',
        ],
    ];
}
