    ...
    <section class="bg-white py-14 lg:py-20">
        <div class="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            <div>
                ...
                <p class="mt-4 max-w-2xl text-base leading-8 text-[#4F463F]">
                ...
                <p class="mt-7 border-l-4 border-l-[#C8A45D] bg-[#F8F1E7] p-4 text-sm font-bold leading-7 text-[#5A3825]">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3">
                <?php foreach ($values as $value) : ?>
                    <div class="rounded-lg border border-[#D8C3A5] border-t-4 border-t-[#C8A45D] bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-[#9A6242] hover:shadow-md">
                        <div class="mb-5 flex h-11 w-11 items-center justify-center rounded-full bg-[#7A7B52] text-white">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7" />
                            </svg>
                        </div>
                        <h3 class="font-heading text-xl font-black text-[#5A3825]"><?php echo esc_html($value['title']); ?></h3>
                        <p class="mt-3 text-sm leading-7 text-[#4F463F]"><?php echo esc_html($value['copy']); ?></p>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
            ...
            <div>
                ...
                <div class="mt-7 grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <?php foreach ($collections as $collection) : ?>
                        <div class="flex min-h-12 items-center gap-3 rounded-lg border border-[#D8C3A5] bg-[#F8F1E7] px-4">
                            <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#9A6242] text-white">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7" />
                                </svg>
                            </span>
                            <span class="text-sm font-bold text-[#24211E]"><?php echo esc_html($collection); ?></span>
                        </div>
                    <?php endforeach; ?>
                </div>
        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:px-8">
            ...
            <div class="space-y-5">
                ...
                <div class="rounded-lg border border-[#C8A45D]/50 bg-[#F8F1E7]/12 p-5">
                    <p class="text-sm font-black uppercase tracking-[0.16em] text-[#C8A45D]">
