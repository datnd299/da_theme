...
const builds = [
  { input: './assets/css/tailwind-input.css', output: './assets/css/tw/tw-ship.css', content: './template-parts/page-shipping-returns.php,./template-parts/page-shipping-policy.php,./template-parts/page-return-refund-policy.php,./template-parts/page-warranty.php,./template-parts/page-collections.php' },
