...
function dawp_virtual_page_map() {
    return [
        ...
        'shipping-policy'          => ['slug' => 'shipping-policy',          'title' => 'Shipping Policy',           'css' => 'tw-legal.css'],
        'return-refund-policy'     => ['slug' => 'return-refund-policy',     'title' => 'Return & Refund Policy',    'css' => 'tw-legal.css'],
        'billing-terms-conditions' => ['slug' => 'billing-terms-conditions', 'title' => 'Billing Terms & Conditions','css' => 'tw-legal.css'],
        'terms-of-service'         => ['slug' => 'terms-of-service',         'title' => 'Terms of Service',          'css' => 'tw-legal.css'],
        'privacy-policy'           => ['slug' => 'privacy-policy',           'title' => 'Privacy Policy',            'css' => 'tw-legal.css'],
    ];
}
