...
function dawp_rank_math_faq_entities() {
    $faq_items = [
        ['Where can I buy GraphicTShirtStore products?', 'Products shown on graphictshirtstore.com are available for direct purchase through our online store. Customers can add available items to the cart and complete checkout on the website.'],
        ...
        ['Where do you ship?', 'GraphicTShirtStore currently ships exclusively within the United States. If a product, destination, or carrier limitation prevents delivery to your specific address, you will be notified at checkout before payment is completed.'],
        ...
        ['Do you charge a restocking fee?', 'No. GraphicTShirtStore does not charge restocking fees for eligible returns.'],
        ['Who pays for return shipping?', 'For defective, damaged, incorrect, or carrier-damaged products, GraphicTShirtStore covers 100% of return shipping and provides a prepaid label by email. For customer remorse, including wrong size, wrong color, changed mind, or does not fit, the customer is responsible for return shipping and the label cost may be deducted from the refund.'],
        ...
        ['Is checkout secure?', 'Yes. Checkout uses SSL-protected payment transmission through WooCommerce and certified third-party payment gateways. GraphicTShirtStore does not store raw credit card numbers on local storefront servers.'],
