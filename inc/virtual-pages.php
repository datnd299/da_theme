...
function dawp_virtual_page_map() {
    return [
        'about-us' => [
            'slug' => 'about',
            'title' => 'About Us',
            'seo_title' => 'About One Shop Vibe | Beauty Essentials & Personal Care',
            'description' => 'Learn about One Shop Vibe, a U.S. beauty essentials store offering practical makeup tools, beauty accessories, hair care items, and personal care products.',
        ...
        'faq' => [
            'slug' => 'faq',
            'title' => 'FAQ',
            'seo_title' => 'FAQ | Orders, Shipping, Returns & Support | One Shop Vibe',
            'description' => 'Find answers about One Shop Vibe orders, free U.S. shipping, delivery times, returns, refunds, payments, privacy, and customer support.',
            'schema_type' => 'FAQPage',
        ...
        'contact-us' => [
            'slug' => 'contact',
            'title' => 'Contact Us',
            'seo_title' => 'Contact One Shop Vibe | Customer Support',
            'description' => 'Contact One Shop Vibe customer support for order help, shipping questions, returns, refunds, and beauty essentials product support.',
        ...
        'shipping-policy' => [
            ...
            'seo_title' => 'Shipping Policy | Free U.S. Shipping | One Shop Vibe',
            'description' => 'Review One Shop Vibe shipping locations, free standard U.S. shipping, 1-3 business day handling, 5-7 business day transit, tracking, and support details.',
            'schema_type' => 'WebPage',
            'image' => '/assets/img/gallery/Oneshopvibe/Beauty_Essentials_Personal_Care.png',
            'css' => 'tw-policy.css',
        ],
        'return-refund-policy' => [
            ...
            'seo_title' => 'Return & Refund Policy | One Shop Vibe',
            'description' => 'Read One Shop Vibe return eligibility, 30-day return window, return shipping fees, refund timing, exchanges, damaged items, and customer support details.',
            'schema_type' => 'WebPage',
        ...
        'terms-conditions' => [
            ...
            'seo_title' => 'Terms & Conditions | One Shop Vibe',
            'description' => 'Read the terms that govern One Shop Vibe website use, order placement, payments, shipping, returns, refunds, and customer support.',
            'schema_type' => 'WebPage',
            'image' => '/assets/img/gallery/Oneshopvibe/Beauty_Organizers.png',
            'css' => 'tw-terms.css',
        ],
        'privacy-policy' => [
            ...
            'seo_title' => 'Privacy Policy | One Shop Vibe',
            'description' => 'Learn how One Shop Vibe collects, uses, protects, and shares personal information when you browse, contact support, or place an order.',
            'schema_type' => 'WebPage',
        ...
        'track-order' => [
            'slug' => 'track-order',
            'title' => 'Track Order',
            'seo_title' => 'Track Your Order | One Shop Vibe',
            'description' => 'Track your One Shop Vibe order with your order number and billing email, review delivery progress, and contact support for shipment help.',
            'schema_type' => 'WebPage',
            'image' => '/assets/img/gallery/Oneshopvibe/Beauty_Accessories.png',
            'css' => 'track-order.css',
        ],
...
function dawp_template_page_seo_map() {
    return [
        'home' => [
            'slug' => 'home',
            'title' => 'Home',
            'seo_title' => 'One Shop Vibe | Beauty Essentials & Personal Care',
            'description' => 'Shop One Shop Vibe for everyday beauty essentials, makeup tools, hair care accessories, beauty organizers, and practical personal care products.',
