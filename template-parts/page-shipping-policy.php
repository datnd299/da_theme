<?php
/**
 * Shipping policy page for Reluxwatches.
 *
 * @package dawp
 */
...
$shipping_faqs = [
    [
        'question' => __('Where does Reluxwatches ship?', 'dawp'),
        'answer'   => __('Reluxwatches currently ships exclusively within the United States domestic market. If a destination or carrier limitation prevents delivery to your address, checkout will notify you before payment is processed.', 'dawp'),
    ],
    [
...
<div class="bg-white text-[#111111]">
    <section class="bg-[#FAFAFA] py-14 sm:py-20" aria-labelledby="shipping-policy-title">
        <div class="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end lg:px-8">
            <div>
                <p class="text-sm font-extrabold uppercase tracking-[0.14em] text-[#405447]"><?php esc_html_e('Shipping Policy', 'dawp'); ?></p>
                <h1 id="shipping-policy-title" class="mt-4 font-heading text-4xl font-extrabold leading-tight text-[#111111] sm:text-5xl">
            ...
            <div class="rounded-md border border-[#E9E9E9] bg-white p-6 shadow-sm">
                ...
                <div class="mt-6 flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
                    <a href="<?php echo esc_url($track_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md bg-[#405447] px-6 text-sm font-bold text-white transition hover:bg-[#2F3F35]">
                        <?php esc_html_e('Track Order', 'dawp'); ?>
                    </a>
                    <a href="<?php echo esc_url($contact_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md border border-[#405447] bg-white px-6 text-sm font-bold text-[#405447] transition hover:bg-[#FAFAFA]">
    ...
    <section class="bg-[#FAFAFA] py-12 sm:py-16">
        ...
        <section class="rounded-md border border-[#E9E9E9] bg-[#FAFAFA] p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="shipping-costs-title">
            <h2 id="shipping-costs-title" class="font-heading text-4xl font-extrabold leading-tight text-[#111111]">
            ...
            <div class="mt-6 grid gap-4 md:grid-cols-2">
                <?php foreach ($shipping_costs as $cost) : ?>
                    <article class="rounded-md border border-[#E9E9E9] bg-white p-5">
                        <h3 class="font-heading text-xl font-extrabold text-[#111111]"><?php echo esc_html($cost['title']); ?></h3>
                        <p class="mt-4 text-sm leading-7 text-[#777777] sm:text-base"><?php echo esc_html($cost['copy']); ?></p>
                    </article>
                <?php endforeach; ?>
            </div>
        </section>

        <section class="rounded-md border border-[#E9E9E9] bg-white p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="delivery-times-title">
            <h2 id="delivery-times-title" class="font-heading text-4xl font-extrabold leading-tight text-[#111111]">
            ...
            <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <?php foreach ($delivery_times as $time) : ?>
                    <article class="rounded-md border border-[#E9E9E9] bg-white p-5">
                        <h3 class="text-sm font-extrabold text-[#111111]"><?php echo esc_html($time['title']); ?></h3>
                        <p class="mt-3 text-sm leading-6 text-[#777777]"><?php echo esc_html($time['copy']); ?></p>
                    </article>
                <?php endforeach; ?>
            </div>
            <p class="mt-6 text-sm leading-7 text-[#777777] sm:text-base">
        ...
        <section class="rounded-md border border-[#E9E9E9] bg-[#FAFAFA] p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="multi-item-title">
            <h2 id="multi-item-title" class="font-heading text-4xl font-extrabold leading-tight text-[#111111]">
        ...
        <section class="rounded-md border border-[#E9E9E9] bg-white p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="carrier-title">
            <h2 id="carrier-title" class="font-heading text-4xl font-extrabold leading-tight text-[#111111]">
                <?php esc_html_e('Carrier Services & Delivery Tracking', 'dawp'); ?>
            </h2>
            <p class="mt-5 text-sm leading-7 text-[#777777] sm:text-base">
                <?php esc_html_e('To guarantee safe and efficient delivery, Reluxwatches partners with trusted domestic U.S. carriers. Orders are shipped using USPS, UPS, FedEx, or DHL.', 'dawp'); ?>
            </p>
            <div class="mt-5 flex flex-wrap gap-3">
                <?php foreach ($carriers as $carrier) : ?>
                    <span class="inline-flex min-h-9 items-center justify-center rounded-full border border-[#E9E9E9] bg-white px-6 text-sm font-extrabold text-[#111111]"><?php echo esc_html($carrier); ?></span>
                <?php endforeach; ?>
            </div>
            <p class="mt-5 text-sm leading-7 text-[#777777] sm:text-base">
            ...
            <div class="mt-7">
                <a href="<?php echo esc_url($track_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-full border border-[#111111] bg-white px-6 text-sm font-extrabold text-[#111111] transition hover:bg-[#2F3F35] hover:text-white">
                    <?php esc_html_e('Track Order', 'dawp'); ?>
                </a>
            </div>
        </section>

        <section class="rounded-md border border-[#E9E9E9] bg-[#FAFAFA] p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="delivery-issues-title">
            <h2 id="delivery-issues-title" class="font-heading text-4xl font-extrabold leading-tight text-[#111111]">
            ...
            <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                <a href="<?php echo esc_url($contact_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-full bg-[#405447] px-6 text-sm font-extrabold text-white transition hover:bg-[#405447]">
                    <?php esc_html_e('Contact Support', 'dawp'); ?>
                </a>
        ...
        <section class="rounded-md border border-[#E9E9E9] bg-white p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="support-contact-title">
            <h2 id="support-contact-title" class="font-heading text-4xl font-extrabold leading-tight text-[#111111]">
        ...
        <section class="rounded-md border border-[#E9E9E9] bg-white p-6 shadow-sm sm:p-8 lg:p-10" aria-labelledby="shipping-faq-title">
            <h2 id="shipping-faq-title" class="font-heading text-4xl font-extrabold leading-tight text-[#111111]">
            ...
            <div class="mt-6 divide-y divide-[#E9E9E9]">
                <?php foreach ($shipping_faqs as $item) : ?>
                    <details class="group py-5 first:pt-0 last:pb-0">
                        ...
                        <p class="mt-3 text-sm leading-7 text-[#777777] sm:text-base"><?php echo esc_html($item['answer']); ?></p>
                    </details>
                <?php endforeach; ?>
            </div>
        </section>
