...
function dawp_virtual_page_map() {
    return [
        'about-us'             => ['slug' => 'about',                'title' => 'About Brickygo', 'desc' => 'Learn more about Brickygo, a modern collectible store for building sets, art figures, blind boxes and display pieces.', 'keywords' => 'Brickygo, about Brickygo, collectible store, building sets, art figures, blind boxes', 'css' => 'tw-about.css', 'canonical_path' => 'about-us', 'schema_type' => 'AboutPage', 'image' => dawp_home_image_url('2.png')],
        'faq'                  => ['slug' => 'faq',                  'title' => 'Brickygo FAQs', 'desc' => 'Find answers to frequently asked questions about shipping, returns, products, payments and support at Brickygo.', 'keywords' => 'Brickygo FAQ, shipping questions, return questions, order support', 'css' => 'tw-faq.css', 'canonical_path' => 'faq', 'schema_type' => 'FAQPage'],
        'contact-us'           => ['slug' => 'contact',              'title' => 'Contact Brickygo', 'desc' => 'Contact Brickygo support for help with orders, tracking, returns, refunds, product questions or privacy requests.', 'keywords' => 'contact Brickygo, Brickygo support, order help, return support', 'css' => 'tw-contact.css', 'canonical_path' => 'contact-us', 'schema_type' => 'ContactPage', 'image' => dawp_home_image_url('17.png')],
        'shipping-returns'     => ['slug' => 'shipping-policy',      'title' => 'Shipping Policy', 'desc' => 'Review Brickygo shipping options, delivery times, order handling, carrier details and U.S. delivery support.', 'keywords' => 'Brickygo shipping policy, delivery times, shipping support, order handling', 'css' => 'tw-ship.css', 'canonical_path' => 'shipping-policy', 'schema_type' => 'WebPage'],
        'shipping-policy'      => ['slug' => 'shipping-policy',      'title' => 'Shipping Policy', 'desc' => 'Review Brickygo shipping options, delivery times, order handling, carrier details and U.S. delivery support.', 'keywords' => 'Brickygo shipping policy, delivery times, shipping support, order handling', 'css' => 'tw-ship.css', 'canonical_path' => 'shipping-policy', 'schema_type' => 'WebPage'],
        'return-refund-policy' => ['slug' => 'return-refund-policy', 'title' => 'Return & Refund Policy', 'desc' => 'Read the Brickygo return and refund policy, including return eligibility, return shipping, exchanges and refund timing.', 'keywords' => 'Brickygo return policy, refund policy, returns, refund timing', 'css' => 'tw-ship.css', 'canonical_path' => 'return-refund-policy', 'schema_type' => 'WebPage'],
        'terms-conditions'     => ['slug' => 'terms-conditions',     'title' => 'Terms & Conditions', 'desc' => 'Read the Brickygo terms and conditions for browsing the website, placing orders, payments, policies and customer support.', 'keywords' => 'Brickygo terms, terms and conditions, store policies, website terms', 'css' => 'tw-terms.css', 'canonical_path' => 'terms-conditions', 'schema_type' => 'WebPage'],
        'privacy-policy'       => ['slug' => 'privacy',              'title' => 'Privacy Policy', 'desc' => 'Learn how Brickygo collects, uses, protects and manages customer information, cookies, privacy requests and account data.', 'keywords' => 'Brickygo privacy policy, customer data, cookies, privacy requests', 'css' => 'tw-privacy.css', 'canonical_path' => 'privacy-policy', 'schema_type' => 'PrivacyPolicy'],
        'track-order'          => ['slug' => 'track-order',          'title' => 'Track Your Brickygo Order', 'desc' => 'Track your Brickygo order online using your order ID and billing email, or contact support for shipment help.', 'keywords' => 'track Brickygo order, order tracking, shipment status, order status', 'css' => 'track-order.css', 'canonical_path' => 'track-order', 'schema_type' => 'WebPage'],
...
function dawp_home_page_seo_data() {
    return [
        'slug'           => 'home',
        'title'          => 'Brickygo - Build. Collect. Display.',
        'desc'           => 'Shop Brickygo for collectible toys, building sets, designer figures, art toys, blind boxes, mini figures and display pieces.',
        'keywords'       => 'Brickygo, collectible toys, building sets, designer figures, blind boxes, mini figures',
        'canonical_path' => '',
        'schema_type'    => 'WebSite',
...
function dawp_virtual_page_title($parts) {
    $brand = function_exists('dawp_get_store_contact') ? dawp_get_store_contact('name') : 'Brickygo';

    // The Site Title / tagline options belong to a shared install and still
    // carry another brand's values, so drive the document title from the theme.
    if (isset($parts['site'])) {
        $parts['site'] = $brand;
    }
    ...
    if (isset($map[$request_uri])) {
        ...
        $parts['title']   = $brand;
        $parts['tagline'] = __('Build. Collect. Display.', 'dawp');
    }
...
function dawp_rank_math_faq_schema_entities($slug) {
    ...
    $items = [
        [
            'question' => 'Where does Brickygo ship?',
            'answer'   => 'Brickygo currently ships exclusively within the United States domestic market.',
        ],
        [
        ...
        [
            'question' => 'How do I contact Brickygo?',
