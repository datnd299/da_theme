    ...
    <div class="qb-wrap qb-content-grid">
      ...
      <div class="qb-policy-stack">
        <section id="overview" class="qb-policy-card">
          ...
          <p><?php esc_html_e('By visiting our site and/or purchasing something from us, you engage in our "Service" and agree to be bound by these Terms of Service ("Terms"), including any additional terms, conditions, and policies referenced here or available by hyperlink, including our Privacy Policy, Shipping Policy, Return & Refund Policy, and 2-Year Limited Warranty.', 'dawp'); ?></p>
        ...
        <section id="liability" class="qb-policy-card">
          ...
          <p><?php esc_html_e('To the fullest extent permitted by law, the Service and all products and services delivered to you through the Service are provided "as is" and "as available", without any warranties or conditions of any kind, either express or implied, except for the Corvel 2-Year Limited Warranty described on our Warranty page and except where prohibited by law.', 'dawp'); ?></p>
        ...
        <section id="entire-agreement" class="qb-policy-card">
          ...
          <p><?php echo esc_html(sprintf('These Terms, together with any policies or operating rules posted by us on this site, including our Privacy Policy, Shipping Policy, Return & Refund Policy, and 2-Year Limited Warranty, constitute the entire agreement between you and %s regarding your use of the Service and supersede any prior or contemporaneous agreements, communications, or proposals.', $brand_name)); ?></p>
        </section>
