...
const builds = [
  { input: './assets/css/tailwind-input.css', output: './assets/css/tw/tw-shipping-policy.css', content: './template-parts/page-shipping-policy.php' },
  { input: './assets/css/tailwind-input.css', output: './assets/css/tw/tw-return-refund-policy.css', content: './template-parts/page-return-refund-policy.php' },
  { input: './assets/css/tailwind-input.css', output: './assets/css/tw/tw-billing-terms.css', content: './template-parts/page-billing-terms.php' },
  { input: './assets/css/tailwind-input.css', output: './assets/css/tw/tw-home.css', content: './template-parts/page-home.php' },
  { input: './assets/css/tailwind-input.css', output: './assets/css/tw/tw-terms-of-service.css', content: './template-parts/page-terms-of-service.php' },
