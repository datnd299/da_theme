    ...
    <section class="bg-[#102A2C] py-14 text-white lg:py-20">
        <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p class="mx-auto mt-4 max-w-3xl text-lg leading-8 text-[#D7DEE8]">
                <?php esc_html_e('Thank you for choosing Rubyinstar. We process tire orders carefully, share tracking after carrier handoff, and keep delivery expectations clear before checkout.', 'dawp'); ?>
            </p>
                    ...
                    <article class="scroll-mt-24 rounded-lg border border-[#E5E7EB] bg-white p-5 shadow-sm sm:p-7 lg:p-10">
                        ...
                        <div class="mt-6 max-w-none text-base leading-7 text-[#4B5563] [&_h3+div]:mt-5 [&_h3+p]:mt-5 [&_li]:leading-7 [&_p+p]:mt-4">
                                ...
                                <table class="w-full min-w-[560px] table-fixed text-left text-sm leading-6 md:min-w-0">
                                    ...
                                    <tbody class="divide-y divide-[#E5E7EB]">
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 align-top"><?php esc_html_e('5-7 business days', 'dawp'); ?></td>
                            ...
                            <ul class="mt-5 list-disc space-y-3 pl-6">
                                ...
                                <li><strong><?php esc_html_e('Order Cutoff:', 'dawp'); ?></strong> <?php esc_html_e('Orders placed after 5:00 PM (GMT-08:00) Pacific Standard Time (Los Angeles) begin processing the next business day.', 'dawp'); ?></li>
                                <li><strong><?php esc_html_e('Estimated Delivery:', 'dawp'); ?></strong> <?php esc_html_e('Most eligible U.S. orders arrive within 6-9 business days after checkout, including handling and transit time.', 'dawp'); ?></li>
                            ...
                            <ul class="mt-5 list-disc space-y-3 pl-6">
                                ...
                                <li><strong><?php esc_html_e('Support Hours:', 'dawp'); ?></strong> <?php esc_html_e('Monday - Friday, 9:00 AM - 5:00 PM (GMT-08:00) Pacific Standard Time (Los Angeles)', 'dawp'); ?></li>
                            </ul>
                        </div>
                    </article>
                </div>
