...
function dawp_cart_count_badge_html($count) {
    $count   = (int) $count;
    $classes = 'cart-count-badge absolute -right-1 -top-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-[#10151C] px-1 text-[11px] font-extrabold text-white';
