<?php
/**
 * Privacy Policy — TimePiece Haven.
 *
    ...
    'sections' => [
        [
            ...
            'body'    => '<p>' . esc_html__('We collect the following categories of personal information:', 'dawp') . '</p>'
                ...
                . '<li>' . esc_html__('Communications: messages you send us by email or through forms, and marketing preferences.', 'dawp') . '</li>'
                . '</ul>'
                . '<p><strong>' . esc_html__('Information collected automatically:', 'dawp') . '</strong></p><ul>'
                . '<li>' . esc_html__('Device and usage data: IP address, browser type, operating system, referring pages, pages viewed, and dates and times of visits;', 'dawp') . '</li>'
                ...
                . '<p>' . esc_html__('We do not knowingly collect sensitive categories of data (such as health, precise geolocation, or government identifiers) and ask that you do not send them to us.', 'dawp') . '</p>',
        ],
        [
            ...
            'body'    => '<ul>'
                ...
                . '<li>' . esc_html__('To comply with legal, tax, and accounting obligations and to enforce our terms.', 'dawp') . '</li>'
                . '</ul>'
        ...
        [
            ...
            'body'    => '<p>' . esc_html__('We do not sell your personal information. We share it only with:', 'dawp') . '</p><ul>'
                . '<li><strong>' . esc_html__('Payment processors', 'dawp') . '</strong> ' . esc_html__('(such as card processors and PayPal) to take payment and screen for fraud;', 'dawp') . '</li>'
        ...
        [
            ...
            'body'    => '<p>' . esc_html__('We use cookies and similar technologies to:', 'dawp') . '</p><ul>'
                . '<li><strong>' . esc_html__('Essential:', 'dawp') . '</strong> ' . esc_html__('keep your cart and session working and secure the checkout. These cannot be switched off;', 'dawp') . '</li>'
                . '<li><strong>' . esc_html__('Analytics:', 'dawp') . '</strong> ' . esc_html__('understand how the site is used so we can improve it;', 'dawp') . '</li>'
                . '<li><strong>' . esc_html__('Advertising:', 'dawp') . '</strong> ' . esc_html__('measure our marketing and, where enabled, show relevant ads on other sites.', 'dawp') . '</li>'
                . '</ul>'
        ...
        [
            ...
            'body'    => '<p>' . esc_html__('We send marketing email only if you opt in. You can unsubscribe at any time using the link in any marketing email or by contacting us. Unsubscribing from marketing does not stop transactional messages about your orders.', 'dawp') . '</p>',
        ],
        [
        ...
        [
            ...
            'body'    => '<p>' . esc_html__('We are based in the United States and process data there. If you contact us from outside the United States, your information will be transferred to and processed in the United States. Where required, we rely on appropriate safeguards such as Standard Contractual Clauses for transfers of data from the EEA or the UK.', 'dawp') . '</p>',
        ],
        [
            ...
            'body'    => '<p>' . esc_html__('Depending on where you live, you may have the right to:', 'dawp') . '</p><ul>'
                ...
                . '<li>' . esc_html__('Opt out of marketing and of "sale" or "sharing" of personal information for targeted advertising;', 'dawp') . '</li>'
        ...
        [
            ...
            'body'    => '<p>' . esc_html__('Our website may contain links to other sites. This policy does not apply to those sites, and we are not responsible for their content or privacy practices. Please review their policies before providing any information.', 'dawp') . '</p>',
        ],
        [
