...
<main class="bg-[#F4F5F6] text-[#0B0B0D]">
  <!-- ================= HERO ================= -->
  <section class="relative overflow-hidden bg-[#0B0B0D] text-white" aria-labelledby="privacy-policy-title">
    ...
    <div class="relative mx-auto grid max-w-7xl items-end gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-10 lg:py-28">
      <div>
        ...
        <h1 id="privacy-policy-title" class="mt-5 font-serif text-5xl font-semibold leading-[1.02] text-[#F4F5F6] sm:text-6xl lg:text-7xl">
        ...
        <div class="mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          <a href="<?php echo esc_url($terms_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-full border border-white/35 px-7 text-sm font-bold uppercase tracking-[0.08em] text-white transition hover:bg-white hover:text-[#0B0B0D]">
            View Terms
          </a>
        </div>
      </div>
  ...
  <!-- ================= OVERVIEW ================= -->
  <section class="bg-[#F4F5F6] py-16 sm:py-20 lg:py-24" aria-labelledby="privacy-overview-title">
    <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:px-10">
      <div>
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#5B5D63]">Policy Overview</p>
        <h2 id="privacy-overview-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#0B0B0D] sm:text-5xl">
      ...
      <div class="rounded-[2rem] border border-[#5B5D63]/10 bg-white p-6 shadow-sm">
        <h3 class="font-serif text-3xl font-semibold text-[#0B0B0D]">Information We Collect</h3>
  ...
  <section class="bg-white py-16 sm:py-20 lg:py-24" aria-labelledby="privacy-use-title">
    <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
      <div class="mb-10 max-w-3xl">
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#5B5D63]">Data Use And Sharing</p>
        <h2 id="privacy-use-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#0B0B0D] sm:text-5xl">
      ...
      <div class="grid gap-6 lg:grid-cols-2">
        <article class="rounded-[2rem] border border-[#5B5D63]/10 bg-[#F4F5F6] p-6 shadow-sm">
          ...
          <h3 class="mt-5 font-serif text-2xl font-semibold text-[#0B0B0D]">How We Use Information</h3>
          <ul class="mt-5 grid gap-3">
            <?php foreach ($use_cases as $item) : ?>
              <li class="flex gap-3 text-sm leading-7 text-[#5B5D63]/72">
                <span class="mt-2 h-2 w-2 shrink-0 rounded-full bg-[#0B0B0D]"></span>
                <span><?php echo esc_html($item); ?></span>
              </li>
            <?php endforeach; ?>
          </ul>
        ...
        <article class="rounded-[2rem] border border-[#5B5D63]/10 bg-[#F4F5F6] p-6 shadow-sm">
          ...
          <h3 class="mt-5 font-serif text-2xl font-semibold text-[#0B0B0D]">When We Share Information</h3>
          <ul class="mt-5 grid gap-3">
  ...
  <section class="bg-[#0B0B0D] py-16 text-white sm:py-20 lg:py-24" aria-labelledby="privacy-cookies-title">
    <div class="mx-auto grid max-w-7xl gap-6 px-5 sm:px-8 lg:grid-cols-3 lg:px-10">
      <article class="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6">
        ...
        <p class="mt-5 text-xs font-bold uppercase tracking-[0.2em] text-white/60">Cookies</p>
        <h2 id="privacy-cookies-title" class="mt-3 font-serif text-3xl font-semibold text-[#F4F5F6]">Cookies help the site work.</h2>
      ...
      <article class="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6">
        ...
        <p class="mt-5 text-xs font-bold uppercase tracking-[0.2em] text-white/60">Security</p>
        <h2 class="mt-3 font-serif text-3xl font-semibold text-[#F4F5F6]">We use reasonable safeguards.</h2>
        <p class="mt-4 text-sm leading-7 text-white/68">
      ...
      <article class="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6">
        ...
        <p class="mt-5 text-xs font-bold uppercase tracking-[0.2em] text-white/60">Retention</p>
        <h2 class="mt-3 font-serif text-3xl font-semibold text-[#F4F5F6]">We retain data only as needed.</h2>
        <p class="mt-4 text-sm leading-7 text-white/68">
  ...
  <!-- ================= RIGHTS ================= -->
  <section class="bg-[#F4F5F6] py-16 sm:py-20 lg:py-24" aria-labelledby="privacy-rights-title">
    <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:px-10">
      <div>
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#5B5D63]">Your Choices And Rights</p>
        <h2 id="privacy-rights-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#0B0B0D] sm:text-5xl">
  ...
  <section class="bg-[#1A1A1D] py-16 text-white sm:py-20 lg:py-24" aria-labelledby="privacy-contact-title">
    <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
      <div class="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 sm:p-8">
        <div class="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <p class="text-xs font-bold uppercase tracking-[0.2em] text-white/60">Questions Or Requests</p>
            <h2 id="privacy-contact-title" class="mt-3 font-serif text-4xl font-semibold text-[#F4F5F6]">Contact us about this Privacy Policy.</h2>
            ...
            <div class="mt-6 grid gap-3 sm:grid-cols-2 lg:max-w-3xl">
              <a href="<?php echo esc_url($shipping_url); ?>" class="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm font-bold text-white/90 transition hover:border-white/30 hover:text-white">Shipping Policy</a>
              <a href="<?php echo esc_url($returns_url); ?>" class="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm font-bold text-white/90 transition hover:border-white/30 hover:text-white">Return & Refund Policy</a>
              <a href="<?php echo esc_url($terms_url); ?>" class="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm font-bold text-white/90 transition hover:border-white/30 hover:text-white">Terms & Conditions</a>
