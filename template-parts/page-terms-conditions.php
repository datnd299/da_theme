...
<div id="primary" class="legal-page bg-[#F7F5EF] font-body text-[#1F2937]">
    <section class="bg-[#1B4F49] py-14 text-white lg:py-20">
        <div class="legal-page__container mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <p class="text-sm font-black uppercase tracking-[0.18em] text-[#C89B3C]"><?php esc_html_e('Carlton Edgeworth Terms', 'dawp'); ?></p>
            ...
            <div class="grid gap-8 lg:grid-cols-[250px_minmax(0,1fr)] lg:items-start">
                ...
                <article class="rounded-lg border border-[#E8D9A6] bg-white p-6 shadow-sm sm:p-8 lg:p-10">
                    <div class="max-w-none text-base leading-8 text-[#475569]
                        ...
                        <p id="terms-overview" class="scroll-mt-24 rounded-lg border border-[#C89B3C]/60 bg-[#F7F5EF] p-4 font-medium text-[#1F6F68]"><?php esc_html_e('Welcome to Carlton Edgeworth ("we", "us", or "our"). These Terms & Conditions ("Terms") govern your access to and use of carltonedgeworth.net (the "Site"), including creating an account, interacting with our customer support, and purchasing our handmade jewelry, vintage-inspired accessories, curated apparel, or artisan gifts (collectively, "Products").', 'dawp'); ?></p>
                        ...
                        <p><?php esc_html_e('All materials on this Site - including but not limited to the Carlton Edgeworth brand name, logos, custom jewelry designs, artistic text, product descriptions, photography, graphics, icons, and layout - are owned by or licensed to us. These materials are fully protected by international copyright, trademark, and intellectual property laws. You may not copy or reuse them without our express written consent.', 'dawp'); ?></p>

                        <h2 id="terms-liability"><?php esc_html_e('8. Limitation of Liability', 'dawp'); ?></h2>
                        <p><?php esc_html_e('To the fullest extent permitted by applicable law, Carlton Edgeworth and its associates shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the website, delays in shipping, or the performance of artisan products purchased through the Site.', 'dawp'); ?></p>
                        ...
                        <p><?php esc_html_e('For questions regarding these Terms & Conditions, order cancellations, or policy inquiries, please contact Carlton Edgeworth directly:', 'dawp'); ?></p>
                        <ul>
                            <li><strong><?php esc_html_e('Brand Name:', 'dawp'); ?></strong> <?php esc_html_e('Carlton Edgeworth', 'dawp'); ?></li>
