    ...
    <section class="track-hero">
        <div class="track-hero__inner">
            ...
            <p class="track-hero__desc">
                <?php esc_html_e('Enter your order details below to see your shipment status. We\'ll help you follow your Elite Shop Express order from checkout to delivery.', 'dawp'); ?>
            </p>
        </div>
    </section>
            ...
            <div class="track-help-box">
                ...
                <div class="track-help-box__content">
                    ...
                    <p class="track-help-box__text">
                        <?php esc_html_e('If you have any trouble, please reach out to the Elite Shop Express support team at ', 'dawp'); ?>
                        <a href="mailto:support@eliteshopexpress.com">support@eliteshopexpress.com</a>
    ...
    <section class="track-more-section">
        <div class="track-more-section__inner">
            <div class="track-more-section__header">
                ...
                <p class="track-more-section__subtitle"><?php esc_html_e('Everything you need for a smooth Elite Shop Express shopping experience.', 'dawp'); ?></p>
            </div>
            <div class="track-more-grid">
                ...
                <a href="<?php echo esc_url(home_url('/return-refund-policy/')); ?>" class="track-more-card">
                    ...
                    <p class="track-more-card__desc"><?php esc_html_e('Review return eligibility, packaging, costs, and refund timing.', 'dawp'); ?></p>
                </a>
                <a href="<?php echo esc_url(home_url('/contact-us/')); ?>" class="track-more-card">
                    ...
                    <p class="track-more-card__desc"><?php esc_html_e('Our Elite Shop Express support team is here to help with order and delivery questions.', 'dawp'); ?></p>
                </a>
