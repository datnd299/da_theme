<?php
/**
 * Terms of Service — TimePiece Haven.
 *
...
dawp_render_legal([
    ...
    'sections' => [
        ...
        [
            ...
            'body'    => '<p>' . esc_html__('You must be at least 18 years old, or the age of majority in your state, and able to enter into a binding contract to place an order. By ordering, you confirm that the payment method used is yours and that the information you provide is accurate.', 'dawp') . '</p>',
        ],
        [
            'heading' => __('Products, descriptions, and availability', 'dawp'),
            'body'    => '<p>' . esc_html__('We describe each watch as accurately as we can, including its movement, case size, strap material, and water resistance rating. Product photos are representative; slight variation in color or finish can occur between screens and production batches. All items are new and genuine. We do not sell replica or counterfeit goods.', 'dawp') . '</p>'
                . '<p>' . esc_html__('Stock and pricing can change without notice. If an item becomes unavailable after you order, we will notify you and offer a full refund.', 'dawp') . '</p>',
        ],
        [
            'heading' => __('Orders and acceptance', 'dawp'),
            'body'    => '<p>' . sprintf(
                /* translators: %s: billing terms link */
                wp_kses_post(__('An order confirmation is an acknowledgment, not acceptance. We accept an order when we dispatch it. We may refuse or cancel an order as set out in our %s, including for stock, pricing errors, failed payment or verification, or suspected fraud or resale activity.', 'dawp')),
        ...
        [
            ...
            'body'    => '<p>' . sprintf(
                /* translators: %s: billing terms link */
                wp_kses_post(__('All prices are in US Dollars and exclude sales tax, which is added at checkout where applicable. Payment terms, accepted methods, and the billing descriptor are described in our %s.', 'dawp')),
                '<a href="' . esc_url(home_url('/billing-terms-conditions/')) . '">' . esc_html__('Billing Terms & Conditions', 'dawp') . '</a>'
            ) . '</p>',
        ],
        [
        ...
        [
            ...
            'body'    => '<p>' . esc_html__('A manufacturer warranty is included with some, but not all, watches. Where a warranty applies, its length and terms are stated on that product\'s page and in the paperwork supplied with the watch. Watches sold without a stated warranty are covered only by the return rights below and by any rights you have under applicable consumer law.', 'dawp') . '</p>'
        ...
        [
            ...
            'body'    => '<p>' . esc_html__('The website is provided "as is" and "as available". Except for any manufacturer warranty supplied with a product and rights you have under applicable consumer law, we make no other warranties, express or implied, including implied warranties of merchantability or fitness for a particular purpose. We do not warrant that the website will be uninterrupted or error-free.', 'dawp') . '</p>',
        ],
        [
        ...
        [
            ...
            'body'    => '<p>' . sprintf(
                /* translators: %s: support email link */
                wp_kses_post(__('If you have a dispute, contact us first at %s so we can try to resolve it informally. Most issues are settled quickly this way.', 'dawp')),
                '<a href="mailto:' . esc_attr($email) . '">' . esc_html($email) . '</a>'
            ) . '</p>',
        ],
        [
        ...
        [
            ...
            'body'    => '<p>' . esc_html__('If any part of these terms is found to be unenforceable, the rest remains in effect.', 'dawp') . '</p>',
        ],
    ],
]);
