...
$faq_groups = [
    ...
    [
        ...
        'items' => [
            ...
            [
                ...
                'answer'   => __('No. Reluxwatches does not sell counterfeit goods, replica logos, unauthorized branded items, dietary supplements, medical devices, regulated products, or items with unverified health claims.', 'dawp'),
            ],
            [
    ...
    [
        ...
        'items' => [
            ...
            [
                'question' => __('Does Reluxwatches store my full credit card number?', 'dawp'),
                'answer'   => __('No. Reluxwatches does not store, view, or retain raw credit card numbers or sensitive payment credentials on our corporate servers.', 'dawp'),
            ],
            [
...
<div class="bg-white text-[#111111]">
    <section class="bg-[#FAFAFA] py-14 sm:py-20" aria-labelledby="faq-title">
        <div class="mx-auto flex max-w-3xl flex-col items-center justify-center px-4 text-center sm:px-6 lg:px-8">
            <p class="text-center text-sm font-extrabold uppercase tracking-[0.14em] text-[#405447]"><?php esc_html_e('FAQs', 'dawp'); ?></p>
            <h1 id="faq-title" class="mt-4 text-center font-heading text-4xl font-extrabold leading-tight text-[#111111] sm:text-5xl">
                <?php esc_html_e('Quick answers for shopping with Reluxwatches.', 'dawp'); ?>
            </h1>
            <p class="mx-auto mt-5 max-w-2xl text-center text-base leading-8 text-[#777777]">
                <?php
                echo esc_html(
                    sprintf(
            ...
            <div class="mt-6 rounded-md border border-[#E9E9E9] bg-white px-5 py-4 shadow-sm">
                <p class="text-sm font-extrabold uppercase tracking-[0.14em] text-[#405447]"><?php esc_html_e('Last Updated', 'dawp'); ?></p>
                <p class="mt-2 font-heading text-2xl font-extrabold text-[#111111]"><?php echo esc_html($last_updated); ?></p>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.78fr_1.22fr] lg:px-8">
            <aside class="hidden lg:block lg:sticky lg:top-24 lg:self-start">
                <div class="rounded-md border border-[#E9E9E9] bg-white p-6 shadow-sm">
                    <h2 id="faq-content-title" class="font-heading text-2xl font-extrabold text-[#111111]"><?php esc_html_e('Helpful links', 'dawp'); ?></h2>
                    ...
                    <div class="mt-6 grid gap-3">
                        <?php foreach ($quick_links as $link) : ?>
                            <a href="<?php echo esc_url($link['url']); ?>" class="block w-full rounded-md border border-[#E9E9E9] bg-[#FFFFFF] p-4 transition hover:border-[#405447] hover:bg-[#FAFAFA]">
                                <span class="block font-heading text-base font-extrabold text-[#111111]"><?php echo esc_html($link['title']); ?></span>
                                <span class="mt-2 block text-sm leading-6 text-[#777777]"><?php echo esc_html($link['copy']); ?></span>
                            </a>
                        <?php endforeach; ?>
                    </div>
                </div>
            ...
            <div class="grid gap-5">
                <?php foreach ($faq_groups as $group) : ?>
                    <section class="rounded-md border border-[#E9E9E9] bg-white p-6 shadow-sm" aria-labelledby="<?php echo esc_attr(sanitize_title($group['label'])); ?>">
                        <h2 id="<?php echo esc_attr(sanitize_title($group['label'])); ?>" class="font-heading text-xl font-extrabold text-[#111111]"><?php echo esc_html($group['label']); ?></h2>
                ...
                <article class="rounded-md border border-[#E9E9E9] bg-[#FAFAFA] p-6 shadow-sm">
                    <h2 class="font-heading text-xl font-extrabold text-[#111111]"><?php esc_html_e('Still need help?', 'dawp'); ?></h2>
                    <p class="mt-4 text-sm leading-7 text-[#777777]">
                        <?php
                        echo esc_html(
                            sprintf(
                    ...
                    <dl class="mt-5 grid gap-4 md:grid-cols-3">
                        ...
                        <?php if ($store_address) : ?>
                            <div class="rounded-md border border-[#E9E9E9] bg-white p-5">
                                <dt class="text-sm font-extrabold text-[#111111]"><?php esc_html_e('Business Address', 'dawp'); ?></dt>
                                <dd class="mt-3 text-sm leading-7 text-[#777777]"><?php echo esc_html($store_address); ?></dd>
                            </div>
                        <?php endif; ?>
                    </dl>
                    <div class="mt-7 flex flex-col gap-3 sm:flex-row">
                        ...
                        <a href="<?php echo esc_url($shop_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md border border-[#405447] bg-white px-6 text-sm font-bold text-[#405447] transition hover:bg-[#FAFAFA]">
