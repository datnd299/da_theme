...
$faq_sections = [
    [
        ...
        'items' => [
            ...
            [
                'question' => __('Where does Carlton Edgeworth ship?', 'dawp'),
                'answer' => [
            ...
            [
                ...
                'answer' => [
                    __('First check the delivery area, building office, mailroom, household members, neighbors, and local carrier office. If the package still cannot be located, email support@carltonedgeworth.net with your order number, tracking number, checkout email, and full delivery address.', 'dawp'),
    ...
    [
        ...
        'items' => [
            [
                'question' => __('What is Carlton Edgeworth\'s return window?', 'dawp'),
                'answer' => [
                    __('You must initiate your return request within 30 days of delivery for eligible items purchased directly from Carlton Edgeworth.', 'dawp'),
            ...
            [
                ...
                'answer' => [
                    ...
                    __('Items must be returned with all original packaging, tags, labels, care cards, pouches, boxes, and any included accessories where applicable. Carlton Edgeworth does not charge restocking fees for eligible returns.', 'dawp'),
                ],
            ],
            [
            ...
            [
                ...
                'answer' => [
                    __('Email support@carltonedgeworth.net or use the Contact Page within 30 days of delivery. Include your order number, checkout email, item(s), reason for return, and photos or videos if the item is damaged.', 'dawp'),
            ...
            [
                ...
                'answer' => [
                    ...
                    __('If you have not received your refund after 15 business days of approval, please check with your bank or card company first, then contact support@carltonedgeworth.net.', 'dawp'),
                ],
            ],
            [
    ...
    [
        ...
        'items' => [
            ...
            [
                ...
                'answer' => [
                    __('Contact support@carltonedgeworth.net as soon as possible if you need to update order details, correct an address, or request cancellation. Changes can only be reviewed before the order has entered fulfillment or shipped.', 'dawp'),
    ...
    [
        ...
        'items' => [
            [
                'question' => __('How does Carlton Edgeworth use my personal information?', 'dawp'),
                'answer' => [
            ...
            [
                'question' => __('Does Carlton Edgeworth store my full credit card number?', 'dawp'),
                'answer' => [
                    __('No. Payment information is processed by trusted third-party payment processors. Carlton Edgeworth does not store full credit card numbers, card security codes, or complete payment credentials on our website servers.', 'dawp'),
            ...
            [
                ...
                'answer' => [
                    ...
                    __('To make a privacy request, contact support@carltonedgeworth.net. We may need enough information to verify your identity and locate the relevant order, account, or contact record.', 'dawp'),
                ],
            ],
            [
                'question' => __('How can I contact Carlton Edgeworth support?', 'dawp'),
                'answer' => [
                    __('For shipping, returns, exchanges, refunds, privacy requests, product details, order status, or policy questions, email support@carltonedgeworth.net with your order number when available.', 'dawp'),
    ...
    <section class="bg-[#5A3825] py-14 text-white lg:py-20">
        <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p class="mx-auto mt-4 max-w-3xl text-lg leading-8 text-[#F8F1E7]">
                <?php esc_html_e('Clear answers about U.S. shipping, free standard delivery, tracking, returns, refunds, products, privacy, and customer support for Carlton Edgeworth orders.', 'dawp'); ?>
            </p>
                    ...
                    <section class="rounded-lg border border-[#D8C3A5] bg-[#5A3825] p-6 text-white shadow-sm sm:p-8 lg:p-10">
                        <div class="mx-auto max-w-3xl text-center">
                            ...
                            <p class="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#F8F1E7]">
                                <?php esc_html_e('Email support@carltonedgeworth.net with your order number when available. Support responds within 24 business hours, Monday through Friday, excluding holidays.', 'dawp'); ?>
                            </p>
                            <div class="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
                                <a href="mailto:support@carltonedgeworth.net" class="inline-flex min-h-12 items-center justify-center rounded-full bg-white px-6 text-sm font-black text-[#34243A] transition hover:bg-[#C8A45D] hover:text-white">
