...
<main class="bg-[#F8F3EC] text-[#2F2A28]">
    <section class="relative overflow-hidden bg-[#241F1D] px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-24">
        <div class="absolute inset-0 opacity-35">
            <img src="<?php echo esc_url($privacy_image); ?>" alt="<?php esc_attr_e('Women\'s shoes, handbags, and accessories arranged for Norvexa privacy policy', 'dawp'); ?>" class="h-full w-full object-cover" loading="eager">
        ...
        <div class="relative mx-auto grid w-[min(100%,1180px)] gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div class="max-w-3xl">
                ...
                <p class="mt-6 max-w-2xl text-base leading-8 text-white/78 sm:text-lg">
                    <?php esc_html_e('At Norvexa, accessible from norvexaholdingsllc.com, we are deeply committed to protecting the privacy, confidentiality, and security of our visitors and customers.', 'dawp'); ?>
                </p>
            </div>
        ...
        <div class="mx-auto w-[min(100%,1180px)] space-y-5">
            ...
            <article class="rounded-[28px] border border-[#D8CEC6] bg-white p-6 shadow-[0_12px_30px_rgba(47,42,40,0.06)] sm:p-8 lg:p-10">
                ...
                <ul class="mt-5 list-disc space-y-3 pl-5 text-base leading-7 text-[#6F625D]">
                    ...
                    <li><?php esc_html_e('With your explicit consent, sending newsletters, new arrival notices, style updates, or promotional marketing offers related to Norvexa. You can opt out of these emails at any time.', 'dawp'); ?></li>
                </ul>
            </article>
            ...
            <article class="rounded-[28px] border border-[#D8CEC6] bg-white p-6 shadow-[0_12px_30px_rgba(47,42,40,0.06)] sm:p-8 lg:p-10">
                ...
                <ul class="mt-5 list-disc space-y-3 pl-5 text-base leading-7 text-[#6F625D]">
                    ...
                    <li><strong class="text-[#2F2A28]"><?php esc_html_e('Legal Compliance:', 'dawp'); ?></strong> <?php esc_html_e('We may disclose information if required to do so by applicable laws, subpoenas, or legal processes to protect the safety, rights, and property of Norvexa, our customers, or the public.', 'dawp'); ?></li>
                </ul>
            </article>
