    ...
    <section class="track-hero">
        <div class="track-hero__inner">
            ...
            <p class="track-hero__desc">
                <?php esc_html_e('Enter your order details below to see your shipment status. We\'ll help you follow your Meridova order from checkout to delivery.', 'dawp'); ?>
            </p>
        </div>
    </section>
            ...
            <div class="track-help-box">
                ...
                <div class="track-help-box__content">
                    ...
                    <p class="track-help-box__text">
                        <?php esc_html_e('If you have any trouble, please reach out to the Meridova support team at ', 'dawp'); ?>
                        <a href="mailto:support@meridova.net">support@meridova.net</a>
    ...
    <section class="track-more-section">
        <div class="track-more-section__inner">
            <div class="track-more-section__header">
                ...
                <p class="track-more-section__subtitle"><?php esc_html_e('Everything you need for a smooth Meridova shopping experience.', 'dawp'); ?></p>
            </div>
            <div class="track-more-grid">
                ...
                <a href="<?php echo esc_url(home_url('/contact-us/')); ?>" class="track-more-card">
                    ...
                    <p class="track-more-card__desc"><?php esc_html_e('Our Meridova support team is here to help with order and delivery questions.', 'dawp'); ?></p>
                </a>
