...
const builds = [
  { input: './assets/css/tailwind-input.css', output: './assets/css/tw/tw-policy.css', content: './template-parts/page-shipping-policy.php,./template-parts/page-return-refund-policy.php' },
