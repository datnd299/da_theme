    ...
    <section class="track-hero">
        <div class="track-hero__inner">
            ...
            <p class="track-hero__desc">
                <?php esc_html_e('Enter your order details below to see your shipment status. We\'ll let you know exactly where your Smartbasketco order is on its way to you.', 'dawp'); ?>
            </p>
        </div>
    </section>
            ...
            <div class="track-help-box">
                ...
                <div class="track-help-box__content">
                    ...
                    <p class="track-help-box__text">
                        ...
                        <a href="mailto:support@smartbasketco.com">support@smartbasketco.com</a>
    ...
    <section class="track-more-section">
        <div class="track-more-section__inner">
            <div class="track-more-section__header">
                ...
                <p class="track-more-section__subtitle"><?php esc_html_e('Everything you need for a smooth Smartbasketco experience.', 'dawp'); ?></p>
            </div>
