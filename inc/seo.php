...
function dawp_get_virtual_seo() {
    ...
    $map = [
        ...
        'shipping-policy' => [
            ...
            'description' => sprintf('%s shipping policy: U.S. delivery, 5:00 PM Pacific Time cutoff, 1-2 business day handling, 3-5 business day transit, free standard shipping, and tracking support.', dawp_brand_name()),
        ],
