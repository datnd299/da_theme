...
<div id="primary" class="bg-[#F4F6F8] font-body text-[#111827]">
    <section class="bg-[#0B1F33] py-14 text-white lg:py-20">
        <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <p class="text-sm font-black uppercase tracking-[0.18em] text-[#F97316]"><?php esc_html_e('Tizezap Privacy', 'dawp'); ?></p>
            ...
            <p class="mx-auto mt-4 max-w-3xl text-lg leading-8 text-[#D7DEE8]">
                <?php esc_html_e('How Tizezap collects, uses, protects, and shares customer information for tire shopping, checkout, fulfillment, and support.', 'dawp'); ?>
            </p>
            ...
            <div class="grid gap-8 lg:grid-cols-[250px_minmax(0,1fr)] lg:items-start">
                <aside class="rounded-lg border border-[#E5E7EB] bg-white p-4 shadow-sm lg:sticky lg:top-24">
                    ...
                    <nav class="mt-4 space-y-2" aria-label="<?php esc_attr_e('Privacy policy sections', 'dawp'); ?>">
                        ...
                        <a class="block rounded-md border border-transparent px-3 py-2 text-sm font-bold text-[#111827] transition hover:border-[#111827] hover:bg-[#F4F6F8]" href="#privacy-rights"><?php esc_html_e('Rights & Choices', 'dawp'); ?></a>
                ...
                <article class="rounded-lg border border-[#E5E7EB] bg-white p-6 shadow-sm sm:p-8 lg:p-10">
                    <div class="max-w-none text-base leading-8 text-[#4B5563]
                        ...
                        <p id="privacy-overview" class="scroll-mt-24 rounded-lg border border-[#BFDBFE] bg-[#EFF6FF] p-4 font-medium text-[#111827]"><?php esc_html_e('This Privacy Policy explains how Tizezap ("we", "us", or "our") collects, uses, shares, protects, and retains personal information when you visit tizezap.com, create an account, contact us, use tracking or support features, or purchase tires from our online store.', 'dawp'); ?></p>
                        ...
                        <p><?php esc_html_e('We collect information reasonably needed to operate our tire store, process purchases, provide support, improve the shopping experience, protect the website, and meet legal obligations. The types of information we may collect include:', 'dawp'); ?></p>
                        <ul>
                            ...
                            <li><strong><?php esc_html_e('Order and tire information:', 'dawp'); ?></strong> <?php esc_html_e('products purchased, tire size, rim size, load index, speed rating, quantity, order number, order status, return or exchange details, customer notes, and customer service history.', 'dawp'); ?></li>
                        ...
                        <ul>
                            ...
                            <li><?php esc_html_e('display tire product information, support tire size and specification review, and help customers compare products;', 'dawp'); ?></li>
                        ...
                        <p><?php esc_html_e('To make a privacy request, contact support@tizezap.com. We may need enough information to verify your identity and locate the relevant order, account, or contact record. We will review and respond to requests according to applicable law. Some information may be retained when required for legal, security, fraud prevention, accounting, transaction, or dispute purposes.', 'dawp'); ?></p>
                        ...
                        <p><?php esc_html_e('Privacy works together with transparent store policies. We aim to show product prices, product availability, tire specifications, shipping options, taxes, fees, payment methods, and purchase conditions before checkout is completed. Our Shipping & Returns page explains processing time, estimated transit time, return eligibility, return steps, refund timing, and tire condition requirements.', 'dawp'); ?></p>
                        <p><?php esc_html_e('Customers are responsible for providing accurate billing, shipping, email, and phone information and for confirming tire size, rim size, load index, speed rating, vehicle compatibility, and quantity before ordering.', 'dawp'); ?></p>
                        ...
                        <p><?php esc_html_e('For privacy questions, account requests, data requests, order-related privacy concerns, or questions about this policy, contact Tizezap:', 'dawp'); ?></p>
                        <ul>
