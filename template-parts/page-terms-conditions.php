...
$terms_sections = [
    [
        ...
        'body'   => [
            __('This website is operated by Norvexa. By accessing our website, browsing products, creating an account, placing an order, or contacting us for support, you agree to these Terms & Conditions Policy and the policies referenced on this site.', 'dawp'),
            __('If you do not agree with these terms, you should not use the website or purchase products from Norvexa.', 'dawp'),
        ],
    ],
    [
        'number' => '02',
    ...
    [
        ...
        'body'   => [
            __('Norvexa offers women\'s shoes, women\'s sandals, women\'s handbags, and fashion accessories. Product descriptions, images, colors, sizes, dimensions, finishes, materials, and care notes are provided to help customers make informed choices.', 'dawp'),
    ...
    [
        ...
        'body'   => [
            __('The website design, page content, photography selections, graphics, logos, text, product presentation, and other site materials are owned by or licensed to Norvexa and are protected by applicable intellectual property laws.', 'dawp'),
            __('You may not copy, reproduce, modify, sell, redistribute, or exploit our website content without written permission from Norvexa.', 'dawp'),
        ],
    ],
    [
        'number' => '09',
    ...
    [
        ...
        'body'   => [
            __('To the fullest extent permitted by applicable law, Norvexa is not liable for indirect, incidental, special, consequential, or punitive damages arising from website use, product use, shipping delays, service interruptions, data loss, unauthorized access, or inability to use the site.', 'dawp'),
    ...
    <section class="relative overflow-hidden bg-[#241F1D] px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-24">
        ...
        <div class="relative mx-auto grid w-[min(100%,1180px)] gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div class="max-w-3xl">
                ...
                <h1 class="mt-7 font-serif text-4xl leading-tight text-white sm:text-6xl"><?php esc_html_e('Terms for using Norvexa.', 'dawp'); ?></h1>
                <p class="mt-6 max-w-2xl text-base leading-8 text-white/78 sm:text-lg">
                    <?php esc_html_e('Please review these terms before using our website or purchasing women\'s shoes, handbags, and accessories from Norvexa.', 'dawp'); ?>
                </p>
            </div>
