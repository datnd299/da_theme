<?php
/**
 * Track order page for luxurytheme.com.
 *
 * @package dawp
 */
        ...
        <div class="track-hero__inner">
            <div class="track-hero__copy">
                ...
                <p class="track-hero__desc">
                    <?php esc_html_e('Enter your order ID and billing email to check the latest status for your luxurytheme.com purchase.', 'dawp'); ?>
                </p>
