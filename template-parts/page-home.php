    ...
    <section id="collections" class="bg-white py-16 md:py-24">
        <div class="mx-auto w-[min(100%-40px,1360px)] md:w-[min(100%-80px,1360px)]">
            <div class="mb-9 grid gap-5 md:grid-cols-12 md:items-end">
                ...
                <p class="text-[15px] leading-7 text-[#5E625F] md:col-span-4 md:col-start-9"><?php esc_html_e('Every collection runs on an automatic mechanical movement. The case, the finishing, and the intent change.', 'dawp'); ?></p>
            </div>
    ...
    <section class="bg-[#0D0F0F] text-white">
        <div class="mx-auto grid w-[min(100%-40px,1360px)] gap-10 py-16 md:w-[min(100%-80px,1360px)] md:grid-cols-12 md:py-24">
            ...
            <div class="flex flex-col justify-center md:col-span-4 md:col-start-9">
                ...
                <p class="mt-6 text-[16px] leading-7 text-[#D8D6CF]"><?php esc_html_e('A focused edit of automatic watches built around the movement, the proportion, and daily presence.', 'dawp'); ?></p>
        ...
        <section class="bg-white py-16 md:py-24">
            <div class="mx-auto w-[min(100%-40px,1360px)] md:w-[min(100%-80px,1360px)]">
                <div class="mb-9 grid gap-5 md:grid-cols-12 md:items-end">
                    ...
                    <p class="text-[15px] leading-7 text-[#5E625F] md:col-span-4 md:col-start-9"><?php esc_html_e('Clean presentation, honest movement details, and product information where it matters.', 'dawp'); ?></p>
                </div>
