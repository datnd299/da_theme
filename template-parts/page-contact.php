            ...
            <div class="relative h-full overflow-hidden rounded-3xl border border-[#EEE5EF] bg-white p-8 shadow-xl shadow-[#141217]/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-[#141217]/10">
                ...
                <div class="flex flex-col divide-y divide-[#EEE5EF]/80">
                    <div class="py-5 first:pt-0">
                        ...
                        <p class="text-[15px] leading-relaxed text-[#6F625D]"><?php esc_html_e('Orders placed before 2:00 PM PST may begin handling the same business day. Orders placed after the cutoff may begin handling the next business day.', 'dawp'); ?></p>
                    </div>
                    ...
                    <div class="py-5">
                        ...
                        <p class="text-[15px] leading-relaxed text-[#6F625D]"><?php esc_html_e('Handling and shipping operate Monday through Saturday, excluding public holidays. Estimated total delivery is 0-1 business days.', 'dawp'); ?></p>
                    </div>
                    ...
                    <div class="py-5 pb-0">
                        ...
                        <p class="text-[15px] leading-relaxed text-[#6F625D]"><?php esc_html_e('Return requests must be made within 30 days of delivery. Items must be new, unused, unworn, and returned by mail in original packaging.', 'dawp'); ?></p>
