...
function qb_product_category_definitions() {
    return apply_filters('dawp_collections', [
        'foundry-collection' => [
            ...
            'description' => 'Corvel\'s core line. Robust self-winding movements, brushed steel cases, and proportions that sit right from the desk to the weekend.',
        ...
        'frontier-collection' => [
            ...
            'description' => 'Field and travel character. High-contrast dials, sapphire crystals, and higher water resistance for watches that keep up with motion.',
        ...
        'prestige-collection' => [
            ...
            'description' => 'The dress tier. Slimmer automatic calibers, polished finishing, and exhibition case backs that show the movement at work.',
