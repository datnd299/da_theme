      ...
      <div class="qb-policy-stack">
        <section id="return-eligibility" class="qb-policy-card">
          ...
          <ul>
            ...
            <li><?php esc_html_e('Packaging: Items must be returned with all original packaging, the watch box, tags, labels, printed materials, and any included accessories.', 'dawp'); ?></li>
