...
if ($category_data) {
    ...
    $description = $queried_term->description ?: 'Browse automatic mechanical watches selected for confident form, refined materials, and everyday presence.';
    ...
    $intro       = 'Shop the full Corvel edit, built around the movement, the proportion, and daily presence.';
