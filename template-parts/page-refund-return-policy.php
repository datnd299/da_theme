...
<main class="bg-[#F4EEE6] text-[#121212]">
  <!-- ================= HERO ================= -->
  <section class="relative overflow-hidden bg-[#121212] text-white" aria-labelledby="return-policy-title">
    ...
    <div class="relative mx-auto grid max-w-7xl items-end gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-10 lg:py-28">
      <div>
        <p class="text-xs font-bold uppercase tracking-[0.22em] text-[#B8955A]">Return & Refund Policy</p>
        <h1 id="return-policy-title" class="mt-5 font-serif text-5xl font-semibold leading-[1.02] text-[#F4EEE6] sm:text-6xl lg:text-7xl">
        ...
        <div class="mt-8 flex flex-col gap-3 sm:flex-row">
          <a href="<?php echo esc_url($support_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-full bg-[#A96538] px-7 text-sm font-bold uppercase tracking-[0.08em] text-white transition hover:bg-white hover:text-[#121212]">
            Start A Return Request
          </a>
          <a href="<?php echo esc_url($shipping_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-full border border-[#A96538] px-7 text-sm font-bold uppercase tracking-[0.08em] text-[#F4EEE6] transition hover:bg-[#A96538] hover:text-white">
  ...
  <section class="bg-[#F4EEE6] py-16 sm:py-20 lg:py-24" aria-labelledby="easy-returns-title">
    <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:px-10">
      <div>
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#A96538]">30-Day Easy Returns</p>
        <h2 id="easy-returns-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#121212] sm:text-5xl">
        ...
        <p class="mt-4 rounded-3xl border border-[#3A2418]/10 bg-white p-5 text-sm font-bold leading-7 text-[#121212] shadow-sm">
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        <?php foreach ($overview_cards as $card) : ?>
          <article class="rounded-3xl border border-[#3A2418]/10 bg-white p-5 shadow-sm">
            <h3 class="font-serif text-xl font-semibold text-[#121212]"><?php echo esc_html($card['title']); ?></h3>
            <p class="mt-3 text-sm leading-7 text-[#3A2418]/72"><?php echo esc_html($card['copy']); ?></p>
          </article>
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <section class="bg-white py-16 sm:py-20 lg:py-24" aria-labelledby="return-costs-title">
    <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
      <div class="mb-10 max-w-3xl">
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#A96538]">Return Costs</p>
        <h2 id="return-costs-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#121212] sm:text-5xl">
      ...
      <div class="grid gap-6 lg:grid-cols-2">
        <article class="rounded-[2rem] border border-[#3A2418]/10 bg-[#F4EEE6] p-6 shadow-sm">
          ...
          <p class="mt-5 text-xs font-bold uppercase tracking-[0.14em] text-[#A96538]">No Cost To The Customer</p>
          <h3 class="mt-2 font-serif text-2xl font-semibold text-[#121212]">Defective, Damaged, Or Incorrect Products</h3>
        ...
        <article class="rounded-[2rem] border border-[#3A2418]/10 bg-[#F4EEE6] p-6 shadow-sm">
          ...
          <p class="mt-5 text-xs font-bold uppercase tracking-[0.14em] text-[#A96538]">Customer Pays Actual Return Shipping</p>
          <h3 class="mt-2 font-serif text-2xl font-semibold text-[#121212]">Customer Remorse / Change Of Mind</h3>
          <p class="mt-3 text-sm leading-7 text-[#3A2418]/72">
          ...
          <p class="mt-3 text-sm font-bold leading-7 text-[#121212]">Original shipping costs are non-refundable.</p>
        </article>
      </div>
    </div>
  </section>
  ...
  <!-- ================= COMMON SCENARIOS ================= -->
  <section class="bg-[#121212] py-16 text-white sm:py-20 lg:py-24" aria-labelledby="return-scenarios-title">
    <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:px-10">
      <div>
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#B8955A]">Common Return Scenarios</p>
        <h2 id="return-scenarios-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#F4EEE6] sm:text-5xl">
      ...
      <div class="grid gap-4">
        <?php foreach ($return_scenarios as $scenario) : ?>
          <article class="rounded-3xl border border-white/10 bg-white/[0.06] p-5">
            <h3 class="font-serif text-xl font-semibold text-[#F4EEE6]"><?php echo esc_html($scenario['title']); ?></h3>
  ...
  <!-- ================= HOW TO RETURN ================= -->
  <section class="bg-[#F4EEE6] py-16 sm:py-20 lg:py-24" aria-labelledby="how-to-return-title">
    <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
      <div class="mb-10 max-w-3xl">
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#A96538]">How To Return An Item</p>
        <h2 id="how-to-return-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#121212] sm:text-5xl">
      ...
      <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
        <?php foreach ($return_steps as $step) : ?>
          <article class="rounded-3xl border border-[#3A2418]/10 bg-white p-6 shadow-sm">
            <span class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#A96538] text-sm font-bold text-white"><?php echo esc_html($step['step']); ?></span>
            <h3 class="mt-5 font-serif text-xl font-semibold text-[#121212]"><?php echo esc_html($step['title']); ?></h3>
            <p class="mt-3 text-sm leading-7 text-[#3A2418]/72"><?php echo esc_html($step['copy']); ?></p>
          </article>
        <?php endforeach; ?>
      </div>

      <div class="mt-8 rounded-[2rem] border border-[#3A2418]/10 bg-white p-6 shadow-sm">
        <h3 class="font-serif text-2xl font-semibold text-[#121212]">What to include in your request</h3>
        <p class="mt-3 text-sm leading-7 text-[#3A2418]/72">
  ...
  <section class="bg-white py-16 sm:py-20 lg:py-24" aria-labelledby="footwear-condition-title">
    <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:px-10">
      <div>
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#A96538]">Footwear Return Condition</p>
        <h2 id="footwear-condition-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#121212] sm:text-5xl">
        ...
        <a href="<?php echo esc_url($size_url); ?>" class="mt-8 inline-flex min-h-12 items-center justify-center rounded-full bg-[#121212] px-7 text-sm font-bold uppercase tracking-[0.08em] text-white transition hover:bg-[#A96538]">
          View Size Guide
        </a>
      </div>
  ...
  <section class="bg-[#3A2418] py-16 text-white sm:py-20 lg:py-24" aria-labelledby="refund-process-title">
    <div class="mx-auto grid max-w-7xl gap-6 px-5 sm:px-8 lg:grid-cols-2 lg:px-10">
      <article class="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 sm:p-8">
        ...
        <p class="mt-5 text-xs font-bold uppercase tracking-[0.2em] text-[#B8955A]">Refund Process</p>
        <h2 id="refund-process-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#F4EEE6]">
      ...
      <article class="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 sm:p-8">
        ...
        <p class="mt-5 text-xs font-bold uppercase tracking-[0.2em] text-[#B8955A]">Exchanges</p>
        <h2 class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#F4EEE6]">
  ...
  <section class="bg-[#F4EEE6] py-16 sm:py-20 lg:py-24" aria-labelledby="non-returnable-title">
    <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:px-10">
      <div>
        <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#A96538]">Non-Returnable Items</p>
        <h2 id="non-returnable-title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-[#121212] sm:text-5xl">
  ...
  <!-- ================= QUESTIONS & CONTACT ================= -->
  <section class="bg-[#121212] py-16 text-white sm:py-20 lg:py-24" aria-labelledby="return-help-title">
    <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
      <div class="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 sm:p-8">
        <div class="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <p class="text-xs font-bold uppercase tracking-[0.2em] text-[#B8955A]">Questions?</p>
            <h2 id="return-help-title" class="mt-3 font-serif text-4xl font-semibold text-[#F4EEE6]">Need help with a return or refund?</h2>
            ...
            <div class="mt-6 grid gap-3 sm:grid-cols-2 lg:max-w-3xl">
              ...
              <div class="rounded-2xl border border-white/10 bg-white/5 p-4">
                <p class="text-xs font-bold uppercase tracking-[0.12em] text-[#B8955A]">Customer Service Hours</p>
