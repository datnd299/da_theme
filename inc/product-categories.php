...
function dawp_tire_category_definitions() {
    return [
        'all-season-tires' => [
            ...
            'cover'       => 'brand-tread-comparison.png',
        ...
        'performance-tires' => [
            ...
            'cover'       => 'vehicle-card-performance.png',
        ...
        'trailer-tires' => [
            ...
            'cover'       => 'vehicle-card-trailer.png',
...
function dawp_tire_category_cover_url($slug) {
    ...
    $file = $category['cover'] ?? 'shop-fulfillment-aisle.png';
