    ...
    <section class="track-hero">
        <div class="track-hero__inner">
            ...
            <p class="track-hero__desc">
                <?php esc_html_e('Enter your order details below to see your shipment status. We will help you follow your Proudlywear order from processing through delivery.', 'dawp'); ?>
            </p>
        </div>
    </section>
        ...
        <div class="track-more-section__inner">
            ...
            <div class="track-more-grid">
                ...
                <a href="<?php echo esc_url(home_url('/contact-us/')); ?>" class="track-more-card">
                    ...
                    <p class="track-more-card__desc"><?php esc_html_e('Our support team is here to help, Monday-Friday, 10:00 AM-6:00 PM PST.', 'dawp'); ?></p>
                </a>
