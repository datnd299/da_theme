    ...
    <div class="mx-auto w-[min(100%-32px,1180px)]">
        <div class="mb-12 text-center">
            ...
            <p class="mx-auto mt-4 max-w-3xl text-lg leading-8 text-[#6B7280]">
                <?php esc_html_e('This policy explains ToyocarTV shipping locations, shipping fees, processing timelines, delivery tracking, and support steps for automotive accessory orders.', 'dawp'); ?>
            </p>
        </div>
        ...
        <div class="space-y-8">
                <section id="shipping-locations" class="rounded-xl border border-[#E5E7EB] bg-white p-8 shadow-card md:p-10">
                    ...
                    <div class="mt-5 space-y-4 leading-8 text-[#6B7280]">
                        <p><?php esc_html_e('We currently ship exclusively within the United States. ToyocarTV serves customers shopping from the United States domestic market.', 'dawp'); ?></p>
                    ...
                    <div class="mt-6 border-l-4 border-[#D71920] bg-[#FFF7ED] p-6 leading-8 text-[#6B7280]">
                        <?php esc_html_e('Some automotive accessory orders may ship separately if items are prepared from different fulfillment batches or require distinct specialized packing methods to ensure safe transit.', 'dawp'); ?>
                    </div>
                </section>
                ...
                <section id="multi-item-orders" class="rounded-xl border border-[#E5E7EB] bg-white p-8 shadow-card md:p-10">
                    ...
                    <div class="mt-5 space-y-4 leading-8 text-[#6B7280]">
                        <p><?php esc_html_e('If your purchase includes multiple automotive accessories or diverse product types, they may be fulfilled from different locations. Consequently, your items may ship separately and arrive in multiple packages.', 'dawp'); ?></p>
                        <p><?php esc_html_e('You will receive unique tracking numbers for each package. Certain special-handling or high-demand automotive accessory items may require extra preparation time due to rigorous address reviews, holiday volume spikes, or safe-handling protocols.', 'dawp'); ?></p>
                    </div>
                </section>
                ...
                <section id="carrier-tracking" class="rounded-xl border border-[#E5E7EB] bg-white p-8 shadow-card md:p-10">
                    ...
                    <p class="mt-5 leading-8 text-[#6B7280]"><?php esc_html_e('To guarantee safe and efficient delivery, ToyocarTV partners with trusted domestic U.S. carriers. Orders are shipped using USPS, UPS, FedEx, or DHL.', 'dawp'); ?></p>
                ...
                <section id="delivery-issues" class="rounded-xl border border-[#E5E7EB] bg-white p-8 shadow-card md:p-10">
                    ...
                    <ul class="mt-5 space-y-3 leading-8 text-[#6B7280]">
                        <li class="rounded-lg bg-[#F7F8FA] p-4"><?php esc_html_e('Your exact order number, such as #TT1001.', 'dawp'); ?></li>
                        ...
                        <li class="rounded-lg bg-[#F7F8FA] p-4"><?php esc_html_e('Clear, well-lit photos if the package container or automotive accessory item arrived damaged.', 'dawp'); ?></li>
                    </ul>
                    <p class="mt-8">
                ...
                <section id="support-contact" class="rounded-xl border border-dashed border-[#D71920]/35 bg-white p-8 shadow-card md:p-10">
                    ...
                    <dl class="mt-6 grid gap-4 md:grid-cols-2">
                        ...
                        <div class="rounded-lg bg-[#F7F8FA] p-5"><dt class="mb-2 text-xs font-black uppercase tracking-widest text-[#D71920]"><?php esc_html_e('Customer Support Email', 'dawp'); ?></dt><dd class="font-bold text-[#111827]">support@toyocartv.com</dd></div>
