...
const builds = [
  { input: './assets/css/tailwind-input.css', output: './assets/css/tw/tw-ship.css', content: './template-parts/page-shipping-policy.php' },
  { input: './assets/css/tailwind-input.css', output: './assets/css/tw/tw-return.css', content: './template-parts/page-return-refund-policy.php,./template-parts/page-policy-content.php' },
