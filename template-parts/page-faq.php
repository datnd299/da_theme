...
$faq_groups = [
    ...
    [
        ...
        'items' => [
            [
                'question' => __('What does Chronel sell?', 'dawp'),
                'answer'   => __('Chronel focuses on luxury watches, fine timepieces, limited editions, mechanical references and premium accessories.', 'dawp'),
            ],
            [
            ...
            [
                ...
                'answer'   => __('No. Chronel does not sell counterfeit goods, replica logos, unauthorized branded items, dietary supplements, medical devices, regulated products, or items with unverified health claims.', 'dawp'),
            ],
            [
                'question' => __('Do your products make medical, safety, or treatment claims?', 'dawp'),
                'answer'   => __('No. Our catalog is focused on luxury watches, fine timepieces and premium accessories. We do not sell dietary supplements, medical devices, regulated products, or items with unverified health claims.', 'dawp'),
            ],
            [
    ...
    [
        ...
        'items' => [
            ...
            [
                ...
                'answer'   => __('No. Chronel does not store, view, or retain raw credit card numbers or sensitive payment credentials on our corporate servers.', 'dawp'),
            ],
            [
            ...
            [
                'question' => __('How do I contact Chronel?', 'dawp'),
                'answer'   => sprintf(
    ...
    <section class="bg-[#F8F5F0] py-14 sm:py-20" aria-labelledby="faq-title">
        <div class="mx-auto flex max-w-3xl flex-col items-center justify-center px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 id="faq-title" class="mt-4 text-center font-heading text-4xl font-extrabold leading-tight text-[#2B2B2B] sm:text-5xl">
                <?php esc_html_e('Quick answers for shopping with Chronel.', 'dawp'); ?>
            </h1>
