...
function dawp_contact_submit() {
    ...
    if (!$admin_sent) {
        wp_send_json_error(['message' => 'Something went wrong. Please email us directly at support@smartbasketco.com.']);
    }
