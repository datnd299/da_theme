...
$shipping_locations_note = __('Some Norvexa orders may ship separately if items are prepared from different fulfillment batches or require distinct specialized packing methods to ensure safe transit.', 'dawp');
...
$delivery_issue_items = [
    ...
    __('Clear, well-lit photos if the package container or Norvexa item arrived damaged.', 'dawp'),
];
?>
    ...
    <section class="relative overflow-hidden bg-[#241F1D] px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-24">
        ...
        <div class="relative mx-auto grid w-[min(100%,1180px)] gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div class="max-w-3xl">
                ...
                <h1 class="mt-7 font-serif text-4xl leading-tight text-white sm:text-6xl"><?php esc_html_e('Shipping details for Norvexa orders.', 'dawp'); ?></h1>
            ...
            <div class="rounded-[28px] border border-white/18 bg-white/10 p-6 backdrop-blur sm:p-8">
                <dl class="grid gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <dd class="mt-2 font-serif text-2xl text-white"><?php esc_html_e('Norvexa', 'dawp'); ?></dd>
                    </div>
                    <div>
        ...
        <div class="mx-auto w-[min(100%,1180px)] space-y-5">
            <article class="rounded-[28px] border border-[#D8CEC6] bg-white p-6 shadow-[0_12px_30px_rgba(47,42,40,0.06)] sm:p-8 lg:p-10">
                ...
                <div class="mt-5 space-y-4 text-base leading-8 text-[#6F625D]">
                    <p><?php esc_html_e('We currently ship exclusively within the United States. Norvexa serves customers shopping from the United States domestic market.', 'dawp'); ?></p>
            ...
            <article class="rounded-[28px] border border-[#D8CEC6] bg-white p-6 shadow-[0_12px_30px_rgba(47,42,40,0.06)] sm:p-8 lg:p-10">
                ...
                <div class="mt-5 space-y-4 text-base leading-8 text-[#6F625D]">
                    <p><?php esc_html_e('If your purchase includes multiple Norvexa items or diverse fashion items, they may be fulfilled from different locations. Consequently, your items may ship separately and arrive in multiple packages.', 'dawp'); ?></p>
                    <p><?php esc_html_e('You will receive unique tracking numbers for each package. Certain intricate or high-demand Norvexa items may require extra preparation time due to rigorous address reviews, holiday volume spikes, or safe-handling protocols.', 'dawp'); ?></p>
                </div>
            </article>
            ...
            <article class="rounded-[28px] border border-[#D8CEC6] bg-white p-6 shadow-[0_12px_30px_rgba(47,42,40,0.06)] sm:p-8 lg:p-10">
                ...
                <p class="mt-5 text-base leading-8 text-[#6F625D]"><?php esc_html_e('To guarantee safe and efficient delivery, Norvexa partners with trusted domestic U.S. carriers. Orders are shipped using USPS, UPS, FedEx, or DHL.', 'dawp'); ?></p>
                ...
                <div class="mt-7 rounded-[24px] border border-[#D8CEC6] p-4 sm:p-5">
                    <dl class="grid gap-4 md:grid-cols-2">
                        <div class="rounded-[18px] border border-[#D8CEC6] bg-white p-5">
                            ...
                            <dd class="mt-3 text-sm leading-7 text-[#6F625D]"><?php esc_html_e('Norvexa', 'dawp'); ?></dd>
                        </div>
                        <div class="rounded-[18px] border border-[#D8CEC6] bg-white p-5">
