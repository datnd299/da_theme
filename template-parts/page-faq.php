...
$faq_groups = [
    ...
    [
        ...
        'items'       => [
            [
                'question' => __('Where does Norvexa ship?', 'dawp'),
                'answer'   => __('Norvexa currently ships eligible orders within the United States. If a product, destination, or carrier limitation prevents delivery to your specific address, the order will not be available for that location at checkout.', 'dawp'),
            ],
            [
    ...
    [
        ...
        'items'       => [
            [
                ...
                'answer'   => __('Email support@norvexaholdingsllc.com or use the Contact Us page. Include your order number if your question is about a recent purchase.', 'dawp'),
            ],
            [
        ...
        <div class="relative mx-auto grid w-[min(100%,1180px)] gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div class="max-w-3xl">
                ...
                <p class="mt-6 max-w-2xl text-base leading-8 text-white/78 sm:text-lg">
                    <?php esc_html_e('Quick answers about Norvexa orders, shipping, delivery, returns, refunds, products, and customer support.', 'dawp'); ?>
                </p>
            </div>
