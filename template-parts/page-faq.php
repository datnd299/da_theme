<?php
/**
 * Frequently Asked Questions - Veterangift
 */
...
<div class="sgs-faq-hero" style="<?php echo esc_attr($sgs_faq_hero_bg); ?>">
  <div class="sgs-faq-hero__inner">
    ...
    <p>Find clear answers about Veterangift orders, free U.S. shipping on orders over $49, tracking, returns, refunds, checkout security, and customer support.</p>
  </div>
</div>
