...
function dawp_get_virtual_seo() {
    ...
    $map = [
        'about-us' => [
            'title'       => 'About Us',
            'description' => 'Corvel is an independent label designing modern automatic mechanical watches across three collections: Foundry, Frontier, and Prestige.',
        ],
        'collections' => [
            'title'       => 'Collections',
            'description' => 'Explore the three Corvel collections — Foundry, Frontier, and Prestige — each built around a mechanical automatic movement and a distinct case character.',
        ],
        'warranty' => [
