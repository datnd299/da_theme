<?php
/**
 * Terms of Service. Served at /terms-conditions/.
 */
    ...
    <div class="container">
        <div class="c-policy-hero__inner">
            <nav class="c-policy-breadcrumb" aria-label="<?php esc_attr_e('Breadcrumb', 'dawp'); ?>">
                ...
                <span><?php esc_html_e('Terms of Service', 'dawp'); ?></span>
            </nav>
            <span class="c-rule" aria-hidden="true"></span>
            <p class="c-eyebrow"><?php esc_html_e('Legal', 'dawp'); ?></p>
            <h1><?php esc_html_e('Terms of Service', 'dawp'); ?></h1>
...
<section class="c-policy-body">
    <div class="container-narrow">
        ...
        <section>
            ...
            <p><?php esc_html_e('Prices are shown in US dollars and exclude sales tax, which is calculated at checkout where applicable. Payment is taken in full at checkout for in-stock watches, processed securely through PayPal.', 'dawp'); ?></p>
            ...
            <p><?php
                printf(
                    ...
                    esc_html__('Accepted payment methods, currency, and billing details are set out in our %s.', 'dawp'),
        ...
        <section>
            <h2><?php esc_html_e('5. Delivery and risk', 'dawp'); ?></h2>
            <p><?php
                printf(
                    /* translators: %s: link to the shipping policy page */
                    esc_html__('Delivery is complimentary, insured, and requires an adult signature. Risk passes to you on delivery. Order cutoff, handling, and transit times are set out in our %s.', 'dawp'),
        ...
        <section>
            <h2><?php esc_html_e('6. Returns and warranty', 'dawp'); ?></h2>
            <p><?php
                printf(
        ...
        <section>
            <h2><?php esc_html_e('7. Accounts', 'dawp'); ?></h2>
        ...
        <section>
            <h2><?php esc_html_e('8. Intellectual property', 'dawp'); ?></h2>
        ...
        <section>
            <h2><?php esc_html_e('9. Acceptable use', 'dawp'); ?></h2>
        ...
        <section>
            <h2><?php esc_html_e('10. Liability', 'dawp'); ?></h2>
        ...
        <section>
            <h2><?php esc_html_e('11. Events outside our control', 'dawp'); ?></h2>
        ...
        <section>
            <h2><?php esc_html_e('12. Governing law', 'dawp'); ?></h2>
        ...
        <section>
            <h2><?php esc_html_e('13. Contact', 'dawp'); ?></h2>
            <p><?php
                printf(
