    ...
    <section class="track-hero">
        <div class="track-hero__inner">
            <div class="track-hero__copy">
                <span class="track-hero__label"><?php esc_html_e('Carlton Edgeworth Order Status', 'dawp'); ?></span>
                <h1 class="track-hero__title"><?php esc_html_e('Track Your Order', 'dawp'); ?></h1>
                <p class="track-hero__desc">
                    <?php esc_html_e('Enter your order number and billing email to review the latest order details available from Carlton Edgeworth.', 'dawp'); ?>
                </p>
            ...
            <div class="track-help-box">
                ...
                <div class="track-help-box__content">
                    ...
                    <p class="track-help-box__text">
                        <?php esc_html_e('If the tracking form cannot find your order, contact Carlton Edgeworth support at ', 'dawp'); ?>
    ...
    <section class="track-more-section">
        <div class="track-more-section__inner">
            <div class="track-more-section__header">
                ...
                <p class="track-more-section__subtitle"><?php esc_html_e('Useful pages and current shop categories for a smoother Carlton Edgeworth order experience.', 'dawp'); ?></p>
            </div>
