...
$footer_columns = function_exists('dawp_footer_columns') ? dawp_footer_columns() : [
    [
        ...
        'links' => [
            ...
            ['title' => __('Mens edit', 'dawp'), 'url' => home_url('/product-category/mens-edit/')],
            ['title' => __('Women Collection', 'dawp'), 'url' => home_url('/product-category/women-collection/')],
            ['title' => __('Personalize apparel', 'dawp'), 'url' => home_url('/product-category/personalize-apparel/')],
        ],
    ],
    [
