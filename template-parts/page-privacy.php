...
<div id="primary" class="legal-page bg-[#F7F5EF] font-body text-[#1F2937]">
    <section class="bg-[#1B4F49] py-14 text-white lg:py-20">
        <div class="legal-page__container mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <p class="text-sm font-black uppercase tracking-[0.18em] text-[#C89B3C]"><?php esc_html_e('Patado LLC Privacy', 'dawp'); ?></p>
            ...
            <div class="grid gap-8 lg:grid-cols-[250px_minmax(0,1fr)] lg:items-start">
                ...
                <article class="rounded-lg border border-[#E8D9A6] bg-white p-6 shadow-sm sm:p-8 lg:p-10">
                    <div class="max-w-none text-base leading-8 text-[#475569]
                        ...
                        <p id="privacy-overview" class="scroll-mt-24 rounded-lg border border-[#C89B3C]/60 bg-[#F7F5EF] p-4 font-medium text-[#1F6F68]"><?php esc_html_e('This Privacy Policy explains how Patado LLC ("we", "us", or "our") collects, uses, shares, protects, and retains personal information when you visit patadollc.com, create an account, contact us, use tracking or support features, or purchase handmade jewelry, vintage-inspired accessories, curated apparel, or artisan gifts from our online store.', 'dawp'); ?></p>
                        ...
                        <p><?php esc_html_e('Privacy works together with transparent store policies. We aim to show product prices, product availability, materials, dimensions or sizing where relevant, shipping options, taxes, fees, payment methods, and purchase conditions before checkout is completed. Our Shipping Policy and Return & Refund Policy explain processing time, estimated transit time, return eligibility, return steps, refund timing, and item condition requirements.', 'dawp'); ?></p>
                        ...
                        <p><?php esc_html_e('For privacy questions, account requests, data requests, order-related privacy concerns, or questions about this policy, please contact Patado LLC through our official channels:', 'dawp'); ?></p>
                        <ul>
