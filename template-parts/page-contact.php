        ...
        <div class="bgs-contact__shell bgs-contact__main-grid">
            <div class="bgs-contact__form-wrap" id="bgs-contact-form">
                ...
                <?php elseif ('captcha' === $contact_status) : ?>
                    <div class="bgs-contact__notice bgs-contact__notice--error" role="alert"><?php esc_html_e('The CAPTCHA check did not pass. Please complete the verification and try again.', 'dawp'); ?></div>
                ...
                <form class="bgs-contact__form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    ...
                    <?php if (function_exists('dawp_turnstile_widget')) { dawp_turnstile_widget(); } ?>
