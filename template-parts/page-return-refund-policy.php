<?php
/**
 * Return and refund policy page for DTI Fitness.
 *
 * @package dawp
 */
...
$return_shipping_fees = [
    [
        ...
        'copy'  => __('DTI Fitness covers the return shipping cost. Once your return is approved, we will email you a prepaid shipping label so you can send the item back to us at no cost to you.', 'dawp'),
    ],
    [
        'title' => __('Customer Remorse / Change of Mind:', 'dawp'),
        'copy'  => __('Free returns within 30 days of delivery, no questions asked. DTI Fitness covers the return shipping cost and emails you a prepaid shipping label.', 'dawp'),
    ],
];
...
<div class="bg-white text-[#2B2B2B]">
    <section class="bg-[#F3F4F1] py-14 sm:py-20" aria-labelledby="return-refund-title">
        <div class="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end lg:px-8">
            <div>
                <p class="text-sm font-extrabold uppercase tracking-[0.14em] text-[#E8442C]"><?php esc_html_e('Return & Refund Policy', 'dawp'); ?></p>
            ...
            <div class="rounded-md border border-[#E1E3DE] bg-white p-6 shadow-sm">
                ...
                <div class="mt-6 flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
                    ...
                    <a href="mailto:<?php echo esc_attr($support_email); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md border border-[#E8442C] bg-white px-6 text-sm font-bold text-[#E8442C] transition hover:bg-[#F3F4F1]">
    ...
    <section class="bg-[#FFFFFF] py-14 sm:py-20">
        <div class="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 lg:px-8">
            <article class="rounded-md border border-[#E1E3DE] bg-white p-6 shadow-sm sm:p-8">
            ...
            <article class="rounded-md border border-[#E1E3DE] bg-[#F3F4F1] p-6 shadow-sm sm:p-8">
            ...
            <article class="rounded-md border border-[#E1E3DE] bg-[#F3F4F1] p-6 shadow-sm sm:p-8">
                ...
                <div class="mt-6 grid gap-4">
                    <?php foreach ($return_steps as $index => $step) : ?>
                        <section class="rounded-md border border-[#E1E3DE] bg-white p-5">
                            <div class="flex items-start gap-4">
                                <span class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#E8442C] text-sm font-extrabold text-white"><?php echo esc_html((string) ($index + 1)); ?></span>
                                <div>
                ...
                <div class="mt-5 rounded-md border border-[#F0C7BE] bg-[#F3F4F1] p-5 text-sm leading-7 text-[#2B2B2B]">
                ...
                <div class="mt-7 flex flex-col gap-3 sm:flex-row">
                    <a href="<?php echo esc_url($contact_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md bg-[#E8442C] px-6 text-sm font-bold text-white transition hover:bg-[#E8442C]">
                        <?php esc_html_e('Contact Support', 'dawp'); ?>
                    </a>
                    <a href="mailto:<?php echo esc_attr($support_email); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md border border-[#E8442C] bg-white px-6 text-sm font-bold text-[#E8442C] transition hover:bg-[#F3F4F1]">
                        <?php echo esc_html($support_email); ?>
            ...
            <article class="rounded-md border border-[#E1E3DE] bg-[#F3F4F1] p-6 shadow-sm sm:p-8">
                ...
                <a href="mailto:<?php echo esc_attr($support_email); ?>" class="mt-7 inline-flex min-h-12 items-center justify-center rounded-md border border-[#E8442C] bg-white px-6 text-sm font-bold text-[#E8442C] transition hover:bg-[#F3F4F1]">
            ...
            <article class="rounded-md border border-[#E1E3DE] bg-[#F3F4F1] p-6 shadow-sm sm:p-8">
                ...
                <div class="mt-6 rounded-md border border-[#E1E3DE] bg-white p-4 sm:p-5">
                    <dl class="grid gap-4 lg:grid-cols-2">
                        <?php foreach ($contact_cards as $card) : ?>
                            <div class="rounded-md border border-[#E1E3DE] bg-[#FFFFFF] p-4">
                                ...
                                <dd class="mt-3 text-sm leading-7 text-[#4A4A4A]">
                                    <?php if (!empty($card['url'])) : ?>
                                        <a class="font-bold text-[#E8442C] underline decoration-[#E8442C]/40 underline-offset-4 transition hover:text-[#B8331F]" href="<?php echo esc_url($card['url']); ?>"><?php echo esc_html($card['value']); ?></a>
                                    <?php else : ?>
