...
function dawp_virtual_page_map() {
    return [
        'home' => [
            ...
            'title'       => 'Home',
            'css'         => 'tw/tw-home.css',
            'seo_title'   => 'Veterangift | Patriotic Apparel & Custom Gifts',
            'description' => 'Shop Veterangift for patriotic apparel, polos, hats, America 250 designs, and custom gifts with free U.S. standard shipping.',
        ...
        'about-us' => [
            ...
            'title'       => 'About Us',
            'css'         => 'tw/tw-about.css',
            'seo_title'   => 'About Veterangift | Patriotic Apparel & Gifts',
            'description' => 'Learn about Veterangift, a patriotic apparel and custom gift brand creating American pride designs for proud Americans.',
            'image'       => 'assets/img/Image New/image copy 8.png',
        ...
        'shop-by-categories' => [
            ...
            'seo_title'   => 'Shop By Categories | Veterangift Patriotic Gifts',
            'description' => 'Shop Veterangift by category, including American flag tees, bomber jackets, hats, premium T-shirts, America 250 designs, and holiday gifts.',
        ...
        'faq' => [
            ...
            'title'       => 'FAQ',
            'css'         => 'tw/tw-faq.css',
            'seo_title'   => 'Veterangift FAQ | Shipping, Returns & Orders',
            'description' => 'Find answers about Veterangift orders, checkout, free U.S. shipping, tracking, returns, refunds, payment security, and customer support.',
        ...
        'contact-us' => [
            ...
            'seo_title'   => 'Contact Veterangift | Customer Support',
            'description' => 'Contact Veterangift for order updates, custom gift details, shipping questions, returns, refunds, delivery issues, and product support.',
            'image'       => 'assets/img/Image New/image copy 9.png',
        ...
        'refund-return-policy' => [
            ...
            'css'         => 'tw/tw-ship.css',
            'seo_title'   => 'Refund & Return Policy | Veterangift',
            'description' => 'Review Veterangift returns and refunds, including the 30-day return window, eligible item condition, return shipping fees, and refund timing.',
            'image'       => 'assets/img/Image New/image copy 9.png',
            'schema_type' => 'WebPage',
        ],
        'terms-conditions' => [
            ...
            'css'         => 'tw/tw-terms.css',
            'seo_title'   => 'Terms & Conditions | Veterangift',
            'description' => 'Read Veterangift terms and conditions for website use, online orders, payment security, product accuracy, returns, and store policies.',
        ...
        'privacy-policy' => [
            ...
            'seo_title'   => 'Privacy Policy | Veterangift',
            'description' => 'Read how Veterangift collects, uses, protects, and shares personal information for orders, checkout, shipping, analytics, and support.',
            'image'       => 'assets/img/Image New/image copy.png',
        ...
        'track-order' => [
            ...
            'title'       => 'Track Order',
            'css'         => 'track-order.css',
            'seo_title'   => 'Track Your Order | Veterangift',
            'description' => 'Track your Veterangift order status securely using your order details, or contact customer support for shipment and delivery help.',
            'image'       => 'assets/img/Image New/image copy 3.png',
            'schema_type' => 'WebPage',
        ],
    ];
