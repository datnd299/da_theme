...
<section class="bg-white">
    ...
    <div class="mx-auto grid w-[min(100%-32px,1180px)] gap-10 py-16 lg:grid-cols-[0.42fr_0.58fr] lg:py-20">
        <div class="space-y-5">
            <?php
            $contact_cards = [
                ['Email Support', 'support@shopmivo.com', 'mailto:support@shopmivo.com', ''],
        ...
        <div class="rounded-2xl border border-[#E5E7EB] bg-white p-6 shadow-card lg:p-10">
            <form id="contact-form" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="contact_message" name="message" rows="6" required class="w-full resize-none rounded-lg border border-[#E5E7EB] bg-[#F7F8FA] px-4 py-3 text-[#111827] focus:border-[#D71920] focus:outline-none" placeholder="<?php esc_attr_e('Include your order number, product name, or question.', 'dawp'); ?>"></textarea>
                </div>
        ...
        <div class="mx-auto w-[min(100%-32px,1180px)]">
            ...
            <div class="grid gap-5 md:grid-cols-3">
                ...
                <a href="<?php echo esc_url(home_url('/faq/')); ?>" class="rounded-xl border border-[#E5E7EB] bg-white p-6 text-center hover:border-[#D71920]">
                    ...
                    <p class="mt-2 text-sm leading-6 text-[#6B7280]"><?php esc_html_e('Find fast answers about orders, products, shipping, and returns.', 'dawp'); ?></p>
                </a>
            </div>
        </div>
    </div>
