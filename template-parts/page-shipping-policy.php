    ...
    <section class="bg-[#5A3825] py-14 text-white lg:py-20">
        <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p class="mx-auto mt-4 max-w-3xl text-lg leading-8 text-[#F8F1E7]">
                <?php esc_html_e('Shipping locations, delivery timelines, carrier tracking, multi-item handling, and support information for Carlton Edgeworth orders.', 'dawp'); ?>
            </p>
        ...
        <div class="mx-auto max-w-6xl space-y-6 px-4 sm:px-6 lg:px-8">
            <article class="rounded-lg border border-[#D8C3A5] bg-white p-6 shadow-sm sm:p-8 lg:p-10">
                ...
                <div class="mt-5 space-y-5 text-base leading-8 text-[#5E554D]">
                    <p><?php esc_html_e('We currently ship exclusively within the United States. Carlton Edgeworth serves customers shopping from the United States domestic market.', 'dawp'); ?></p>
            ...
            <article class="rounded-lg border border-[#D8C3A5] bg-white p-6 shadow-sm sm:p-8 lg:p-10">
                ...
                <p class="mt-5 text-base leading-8 text-[#5E554D]"><?php esc_html_e('To support safe and efficient delivery, Carlton Edgeworth partners with trusted domestic U.S. carriers. Orders are shipped using USPS, UPS, FedEx, or DHL.', 'dawp'); ?></p>
