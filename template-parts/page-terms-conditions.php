<?php
/**
 * Terms and conditions page for GraphicShirt.
 *
 * @package dawp
 */
...
$terms_highlights = [
    [
        ...
        'copy'  => __('GraphicShirt sells patriotic apparel, graphic apparel, patriotic decor, everyday style essentials, and giftable finds.', 'dawp'),
    ],
    [
...
$sections = [
    [
        ...
        'copy'  => [
            __('These Terms of Service govern your use of graphicshirt.com and purchases made from GraphicShirt. By using this website or placing an order, you agree to these terms.', 'dawp'),
            __('GraphicShirt is a patriotic apparel and American-inspired decor store focused on practical graphic T-shirts, caps and flags, patriotic apparel, fashion accents, everyday style essentials, and giftable accessories.', 'dawp'),
        ],
    ],
    [
        ...
        'copy'  => [
            ...
            __('You may not misuse the site, attempt unauthorized access, submit false order information, or use GraphicShirt content for misleading, unlawful, or infringing purposes.', 'dawp'),
        ],
    ],
    [
        ...
        'copy'  => [
            ...
            __('GraphicShirt does not sell counterfeit designer products, fake branded apparel, supplements, medical skincare treatments, or products with misleading product claims.', 'dawp'),
        ],
    ],
    [
    ...
    [
        ...
        'copy'  => [
            ...
            __('Eligible unworn apparel and unused decor must meet original-condition requirements. Refunds are issued to the original payment method after returned items are received and inspected.', 'dawp'),
        ],
    ],
    [
        'title' => __('8. Account and Customer Information', 'dawp'),
        'copy'  => [
            __('You are responsible for providing accurate contact, billing, shipping, and order information. GraphicShirt is not responsible for delays or failed delivery caused by incorrect or incomplete customer information.', 'dawp'),
    ...
    [
        ...
        'copy'  => [
            __('Website text, layout, images, graphics, logos, and other content are owned by or licensed to GraphicShirt and may not be copied, reproduced, or used for commercial purposes without permission, except as allowed by law.', 'dawp'),
        ],
    ],
    [
        'title' => __('10. Limitation of Liability', 'dawp'),
        'copy'  => [
            __('To the fullest extent permitted by law, GraphicShirt is not liable for indirect, incidental, special, consequential, or punitive damages related to website use, product use, delivery delays, or inability to access the site.', 'dawp'),
    ...
    [
        ...
        'copy'  => [
            __('We may update these Terms of Service from time to time. Updated terms will be posted on this page and apply to website use and orders after posting.', 'dawp'),
        ],
    ],
    [
        'title' => __('12. Contact', 'dawp'),
        'copy'  => [
            __('Questions about these terms, an order, or store policies can be sent to support@graphicshirt.com.', 'dawp'),
        ],
    ],
];
?>
...
<div class="bg-white text-[#102A43]">
    <section class="bg-[#F7F3EA] py-14 sm:py-20" aria-labelledby="terms-title">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
                <div>
                <p class="text-sm font-extrabold uppercase tracking-[0.14em] text-[#B83232]"><?php esc_html_e('Terms of Service', 'dawp'); ?></p>
                    <h1 id="terms-title" class="mt-4 font-heading text-4xl font-extrabold leading-tight text-[#102A43] sm:text-5xl">
                        <?php esc_html_e('Store terms for shopping with GraphicShirt.', 'dawp'); ?>
                    </h1>
                    <p class="mt-5 max-w-2xl text-base leading-8 text-[#52657A]">
                        <?php esc_html_e('These terms explain website use, ordering, product information, payments, shipping, returns, and customer responsibilities for GraphicShirt.', 'dawp'); ?>
                    </p>
                </div>
                ...
                <div class="grid gap-4 md:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
                    <?php foreach ($terms_highlights as $highlight) : ?>
                        <article class="rounded-md border border-[#D6DEE8] bg-white p-5 shadow-sm">
                            <h2 class="font-heading text-lg font-extrabold text-[#102A43]"><?php echo esc_html($highlight['title']); ?></h2>
                            <p class="mt-3 text-sm leading-6 text-[#52657A]"><?php echo esc_html($highlight['copy']); ?></p>
                        </article>
                    <?php endforeach; ?>
                </div>
            </div>
    ...
    <section class="bg-[#FBFCFE] py-14 sm:py-20" aria-labelledby="terms-content-title">
        <div class="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.78fr_1.22fr] lg:px-8">
            <aside class="lg:sticky lg:top-24 lg:self-start">
                <div class="rounded-md border border-[#D6DEE8] bg-white p-6 shadow-sm">
                    <h2 id="terms-content-title" class="font-heading text-2xl font-extrabold text-[#102A43]"><?php esc_html_e('Important policy links', 'dawp'); ?></h2>
                    ...
                    <div class="mt-6 grid gap-3">
                        <a href="<?php echo esc_url($shipping_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md bg-[#C83E3E] px-5 text-sm font-bold text-white transition hover:bg-[#102A43]">
                            <?php esc_html_e('Shipping & Returns', 'dawp'); ?>
                        </a>
                        <a href="<?php echo esc_url($privacy_url); ?>" class="inline-flex min-h-12 items-center justify-center rounded-md border border-[#C83E3E] bg-white px-5 text-sm font-bold text-[#9B2C2C] transition hover:bg-[#E8EEF5]">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="rounded-md border border-[#D6DEE8] bg-white p-6 sm:p-8">
                <div class="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                    <div>
                        <p class="text-sm font-extrabold uppercase tracking-[0.14em] text-[#B83232]"><?php esc_html_e('Support', 'dawp'); ?></p>
                        <h2 class="mt-3 font-heading text-2xl font-extrabold text-[#102A43]"><?php esc_html_e('Questions about these terms?', 'dawp'); ?></h2>
