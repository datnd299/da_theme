...
$support_email  = 'support@brickygo.com';
...
<header id="site-header" class="sticky top-0 z-50 border-b border-[#E5E7EB] bg-[#FFFFFF]/95 text-[#1F2937] backdrop-blur" role="banner">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex min-h-20 items-center justify-between gap-4">
            <a href="<?php echo esc_url($home_url); ?>" class="inline-flex shrink-0 items-center py-2" aria-label="<?php esc_attr_e('Brickygo home', 'dawp'); ?>">
                <?php
                echo function_exists('dawp_get_responsive_image')
                    ? dawp_get_responsive_image($logo_url, __('Brickygo', 'dawp'), 'site-logo-img', 128, 128, 'eager', '(max-width: 520px) 104px, 128px', 'high')
                    : '<img class="site-logo-img" src="' . esc_url($logo_url) . '" width="1290" height="1290" alt="' . esc_attr__('Brickygo', 'dawp') . '" decoding="async" fetchpriority="high">';
                ?>
            </a>
